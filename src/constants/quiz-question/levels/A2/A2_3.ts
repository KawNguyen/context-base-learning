...
export const questionsA2_3: Question[] = [
  {
    "id": "A2-1098",
    ...
    "questionEn": "The CEO _____ address the entire company via a livestream next Wednesday.",
    "questionVi": "CEO _____ sẽ diễn thuyết trước toàn công ty thông qua một buổi phát trực tiếp vào thứ Tư tới.",
    "options": [
      {
        "option": "will",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "Our department _____ currently _____ with an external agency to develop the new website.",
    "questionVi": "Phòng của chúng tôi hiện _____ đang _____ với một đại lý bên ngoài để phát triển trang web mới.",
    "options": [
      {
        "option": "is / working",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "The new staff cafeteria is located _____ the basement of the main building.",
    "questionVi": "Nhà ăn nhân viên mới nằm _____ ở tầng hầm của tòa nhà chính.",
    "options": [
      {
        "option": "in",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "The janitorial staff _____ the entire office building every night after 9:00 PM.",
    "questionVi": "Nhân viên vệ sinh _____ toàn bộ tòa nhà văn phòng vào mỗi đêm sau 9 giờ tối.",
    "options": [
      {
        "option": "clean",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "Most employees _____ that the team-building workshop last month was very helpful.",
    "questionVi": "Hầu hết nhân viên _____ rằng buổi hội thảo xây dựng đội ngũ tháng trước rất hữu ích.",
    "options": [
      {
        "option": "agree",
        "isCorrect": false
  ...
  },
  {
    ...
    "questionEn": "The new marketing assistant is very _____ and has already contributed many great ideas.",
    "questionVi": "Trợ lý tiếp thị mới rất _____ và đã đóng góp nhiều ý tưởng tuyệt vời.",
    "options": [
      {
        "option": "creative",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "The completion of the project _____ likely be delayed due to unforeseen circumstances.",
    "questionVi": "Việc hoàn thành dự án _____ có khả năng sẽ bị trì hoãn do những tình huống không lường trước được.",
    "options": [
      {
        "option": "will",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "The specialized technicians _____ currently _____ the security system in the main hall.",
    "questionVi": "Các kỹ thuật viên chuyên trách hiện _____ đang _____ hệ thống an ninh ở sảnh chính.",
    "options": [
      {
        "option": "are / upgrading",
        "isCorrect": true
      },
      {
        "option": "is / upgrading",
  ...
  },
  {
    ...
    "questionEn": "_____ the supermarket _____ until midnight on weekends?",
    "questionVi": "_____ Siêu thị _____ có mở cửa đến tận nửa đêm vào cuối tuần không?",
    "options": [
      {
        "option": "Does / open",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "The committee _____ the new safety regulations during the meeting yesterday.",
    "questionVi": "Ủy ban _____ các quy định an toàn mới trong cuộc họp ngày hôm qua.",
    "options": [
      {
        "option": "approved",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "Please ensure that your proposals are submitted _____ no later than 5:00 PM on Friday.",
    "questionVi": "Hãy đảm bảo rằng các đề xuất của bạn được nộp _____ không muộn hơn 5 giờ chiều thứ Sáu.",
    "options": [
      {
        "option": "by",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "The shipment of new computers _____ arrive from the warehouse next Monday.",
    "questionVi": "Lô hàng máy tính mới _____ sẽ đến từ kho vào thứ Hai tới.",
    "options": [
      {
        "option": "will",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionEn": "Mr. Yamamoto is currently waiting _____ the reception area on the ground floor.",
    "questionVi": "Ông Yamamoto hiện đang đợi _____ khu vực tiếp tân ở tầng trệt.",
    "options": [
      {
        "option": "in",
        "isCorrect": true
