...
export const questionsB1_2: Question[] = [
  {
    id: "B1-0101",
  ...
  },
  {
    ...
    questionVi:
      "Nếu khách hàng đều tin tưởng rằng sự phối màu được đề xuất không thu hút, người thiết kế nội thất có thể điều chỉnh.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Đối với việc đặt chỗ cho bữa tối thứ Sáu, hãy tăng số chỗ ngồi từ 8 lên thành 10 khách.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Ông Brandt đã yêu cầu biểu ngữ được treo trên mặt ngoài bức tường của toà nhà.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Bạn nên giữ lấy hóa đơn vừa được phát hành, phòng trường hợp bạn gặp phải vấn đề với thiết bị này trong tương lai.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Nếu vấn đề về mũi của bệnh nhân không có dấu hiệu thuyên giảm trong vòng hai ngày, anh ta nên đến khám lại.",
    options: [
  ...
  },
  {
    ...
    questionType: "grammar",
    questionEn:
      "Those giving demonstrations at the department store _____ explained the product's features and benefits.",
    questionVi:
      "Những người giới thiệu tại cửa hàng đã giải thích một cách nhiệt tình những tính năng và ích lợi của sản phẩm.",
    options: [
  ...
  },
  {
    ...
    questionType: "grammar",
    questionEn:
      "Because its latest exhibit is highly valuable, the Gabe Gallery took more precautions than it _____ did in the past.",
    questionVi:
      "Vì buổi triển lãm gần đây nhất của Gabe Gallery rất quan trọng, họ đã cẩn trọng với nó hơn tất cả những buổi triển lãm họ đã từng thực hiện trong quá khứ.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Bất kỳ ai thực hiện những thay đổi thuộc về cấu trúc của toà nhà trước hết phải nộp đơn xin giấy phép xây dựng.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Các nhân viên tham dự buổi hội thảo về cải thiện kỹ năng giao tiếp sẽ được trao một chứng chỉ bởi người hướng dẫn.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Bên cạnh khoa đào tạo nổi tiếng của ban Khoa học, trường đại học này còn có trang thiết bị phòng thí nghiệm vô cùng tiên tiến.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Số tiền quyên góp nhận được từ người gây quỹ sẽ được chia đều cho cả ba địa điểm của quỹ từ thiện.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Không kể đến số tuổi của tòa nhà, hệ thống thông gió phải được cập nhật cùng với tất cả các mã an toàn.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Sự chậm trễ tàu trên tuyến Trenton đã bị gây ra bởi một lỗi sai tại một trong số các nhà ga.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Vì chúng tôi sẽ nhận được hàng trăm đơn ứng cử cho vị trí này, bạn hãy giới hạn bản sơ yếu lý lịch của mình trong độ dài hai trang giấy.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Giảng viên sẽ tập trung vào cuộc đấu tranh giành độc lập của đất nước khi ông ấy giảng giải.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Hoạt động chào mừng là một cơ hội để cải thiện sự giao tiếp giữa các tình nguyện viên trước khi dự án bắt đầu.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Các ban công nối với các phòng ở Khách sạn Orwell cung cấp một góc nhìn tuyệt đẹp ra bãi biển riêng.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Xác nhận mua vé của đại lý du lịch đã được gửi đến cho khách hàng qua email ngay khi hoàn thành việc thanh toán.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Vì bị khiếm thính, Ms. Frasier sẽ được đồng hành bởi một chuyên gia ngôn ngữ ký hiệu để cô ấy có thể tham gia hội thảo.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Đội phát triển dự án tham gia một phần trách nhiệm đối với việc lựa chọn và việc đánh giá các địa điểm xây dựng tiềm năng.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Gói bữa ăn dễ dàng chuẩn bị gồm có tất cả những nguyên liệu cần thiết cho bữa tối của một người ăn, trừ nước sôi.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Trung tâm giáo dục cung cấp các lớp đào tạo những kỹ năng quan trọng mà người thất nghiệp có thể tìm được việc làm dễ dàng hơn.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Những điều khoản của thỏa thuận cấp phép khá dễ hiểu và không cần phải có kiến thức về luật pháp mới hiểu được.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Những tài liệu thông tin được gửi đến cho người tham gia hội nghị tóm lược lịch trình thuyết trình và các sự kiện xã hội.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Bạn có thể chọn gửi hàng trực tiếp đến nhà hoặc tự mình đến lấy tại cửa hàng, bất cứ cái nào tùy bạn chọn.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Các chất có trong tự nhiên được dùng trong sản phẩm bổ sung vitamin này thay vì hoá chất.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Tài xế xe buýt đã sử dụng con phố ngang để đi thay vì đường cao tốc chính, nhờ vậy đã tránh được giao thông đông đúc vào giờ cao điểm.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Đội ngũ thợ sẽ phá dỡ xong phần chính của toà nhà trước khi những chiếc xe chở phế liệu đến lúc 3 giờ 30.",
    options: [
  ...
  },
  {
    ...
    questionVi:
      "Nếu thấy bất kỳ lỗi sản xuất nào trên chiếc tivi độ nét cao của mình, bạn hãy liên hệ với nơi mua hàng sớm nhất có thể.",
    options: [
