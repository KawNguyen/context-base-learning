...
export const questionsA1_2: Question[] = [
  ...
  },
  {
    ...
    "questionVi": "Nhóm của chúng tôi _____ chào đón một thực tập sinh mới vào hôm nay.",
    "options": [
      {
        "option": "welcome",
        "isCorrect": false
  ...
  },
  {
    ...
    "questionVi": "Chiếc máy tính xách tay này thuộc _____ phòng Công nghệ thông tin.",
    "options": [
      {
        "option": "to",
        "isCorrect": true
  ...
  },
  {
    ...
    "questionVi": "Các nhân viên _____ đang tham dự buổi hội thảo an toàn bây giờ.",
    "options": [
      {
        "option": "is",
        "isCorrect": false
  ...
  },
  {
    ...
    "questionVi": "Nhân viên vệ sinh của chúng tôi _____ dọn dẹp văn phòng mỗi tối.",
    "options": [
      {
        "option": "clean",
        "isCorrect": false
  ...
  },
  {
    ...
    "questionVi": "John _____ đã để bản báo cáo trên bàn làm việc của mình vào ngày hôm qua.",
    "options": [
      {
        "option": "leave",
        "isCorrect": false
