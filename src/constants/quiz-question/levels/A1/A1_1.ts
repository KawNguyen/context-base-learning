...
export const questionsA1_1: Question[] = [
  {
    "id": "A1-0001",
  ...
  },
  {
    ...
    "explanationVi": "Thì Hiện tại tiếp diễn: S + am/is/are + V-ing. 'They' đi with 'are'.",
  ...
  },
  {
    ...
    "explanationVi": "Phủ định hiện tại đơn with động từ thường, chủ ngữ 'I' dùng 'do not'.",
    "category": "Present Simple"
  },
  {
    "id": "A1-0043",
  ...
  },
  {
    ...
    "questionVi": "Tôi không thể tìm thấy chìa khóa của mình. Tôi đã làm mất _____ chúng rồi.",
    "options": [
      {
        "option": "they",
        "isCorrect": false
