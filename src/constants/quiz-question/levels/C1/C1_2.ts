...
export const questionsC1_2: Question[] = [
  {
    id: "C1-1004",
  ...
  },
  {
    ...
    options: [
      {
        option: "could identify",
        isCorrect: false,
      },
      {
        option: "could have identified",
        isCorrect: true,
      },
      {
        option: "must have identified",
        isCorrect: false,
      },
      {
        option: "might identify",
        isCorrect: false,
      },
    ],
    explanationVi:
  ...
  },
  {
    ...
    options: [
      ...
      {
        option: "steps forward",
        isCorrect: false,
      },
      {
        option: "stepped forward",
        isCorrect: false,
      },
      {
        option: "stepping forward",
        isCorrect: false,
      },
    ],
    explanationVi:
  ...
  },
  {
    ...
    options: [
      {
        option: "is widely thought",
        isCorrect: true,
      },
      {
        option: "is widely thinking",
        isCorrect: false,
      },
      {
        option: "widely thinks",
        isCorrect: false,
      },
      {
        option: "was widely thought",
        isCorrect: false,
      },
    ],
    explanationVi:
  ...
  },
  {
    ...
    options: [
      ...
      {
        option: "To be reached",
        isCorrect: false,
      },
      {
        option: "Having reached",
        isCorrect: false,
      },
    ],
  ...
  },
  {
    ...
    options: [
      {
        option: "would not be showing",
        isCorrect: true,
      },
      {
        option: "would not show",
        isCorrect: false,
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      {
        option: "controversially",
        isCorrect: false,
      },
      {
        option: "controversiality",
        isCorrect: false,
      },
    ],
    explanationVi:
  ...
  },
  {
    ...
    options: [
      ...
      {
        option: "couldn't have",
        isCorrect: false,
      },
      {
        option: "mightn't have",
        isCorrect: false,
      },
    ],
    explanationVi:
  ...
  },
  {
    ...
    options: [
      ...
      {
        option: "To be confronted",
        isCorrect: false,
      },
      {
        option: "Having confronted",
        isCorrect: false,
      },
    ],
    explanationVi:
  ...
  },
  {
    ...
    options: [
      {
        option: "would not be losing",
        isCorrect: true,
      },
      {
        option: "would not lose",
        isCorrect: false,
      },
      {
        option: "will not lose",
        isCorrect: false,
      },
      {
        option: "would not have lost",
        isCorrect: false,
      },
    ],
    explanationVi:
  ...
  },
  {
    ...
    options: [
      {
        option: "is widely reputed",
        isCorrect: true,
      },
      {
        option: "is widely reputing",
        isCorrect: false,
      },
      {
        option: "widely reputes",
        isCorrect: false,
      },
      {
        option: "was widely reputed",
        isCorrect: false,
      },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      {
        option: "To be concerned",
        isCorrect: false,
      },
      {
        option: "Having concerned",
        isCorrect: false,
      },
    ],
    explanationVi:
  ...
  },
  {
    ...
    options: [
      {
        option: "would not be in",
        isCorrect: true,
      },
      {
        option: "would not have been in",
        isCorrect: false,
      },
      {
