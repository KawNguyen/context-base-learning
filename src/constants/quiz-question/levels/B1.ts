...
export const questions: Question[] = [
  ...
  {
    id: "B1-0161",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "Should the customer believe that the proposed color scheme is not _____, the interior designer can make adjustments.",
    questionVi: "Nếu khách hàng đều tin tưởng rằng sự phối màu được đề xuất không thu hút, người thiết kế nội thất có thể điều chỉnh.",
    options: [
      { option: "attract", isCorrect: false },
      { option: "attractive", isCorrect: true },
      { option: "attracted", isCorrect: false },
      { option: "attractively", isCorrect: false },
    ],
    explanationVi:
      "Giải thích: Chỗ trống nằm sau động từ \"to be\" (is not) --> điền tính từ hoặc danh từ --> chọn tính từ \"attractive\". Nếu khách hàng đều tin tưởng rằng sự phối màu được đề xuất không thu hút, người thiết kế nội thất có thể điều chỉnh.",
    category: "Grammar",
  },
  {
    id: "B1-0162",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "For Friday's dinner reservation, please _____ the number of seats from eight to ten guests.",
    questionVi: "Đối với việc đặt chỗ cho bữa tối thứ Sáu, hãy tăng số chỗ ngồi từ 8 lên thành 10 khách.",
    options: [
      { option: "increase", isCorrect: true },
      { option: "reflect", isCorrect: false },
      { option: "merge", isCorrect: false },
      { option: "invite", isCorrect: false },
    ],
    explanationVi:
      "Dịch đáp án:\nA. increase (v): tăng\nB. reflect (v): phản ánh\nC. merge (v): hợp nhất\nD. invite (v): mời\nPhân tích: Đây là câu về từ vựng nên bạn cần dựa vào nghĩa để đưa ra đáp án chính xác.\nA. tăng\nB. phản ánh\nC. sáp nhập\nD. mời\n=> Đáp án đúng là A “increase”.\nDịch câu: Đối với việc đặt chỗ cho bữa tối thứ Sáu, hãy tăng số chỗ ngồi từ 8 lên thành 10 khách.",
    category: "Grammar",
  },
  {
    id: "B1-0163",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "Mr. Brandt asked for the banner to be hung _____ the exterior wall of the building.",
    questionVi: "Ông Brandt đã yêu cầu biểu ngữ được treo trên mặt ngoài bức tường của toà nhà.",
    options: [
    ...
    explanationVi:
      "Giải thích: \"Treo lên tường\" thì chúng ta cần dùng giới từ \"on\". Ông Brandt đã yêu cầu biểu ngữ được treo trên mặt ngoài bức tường của toà nhà.",
    category: "Grammar",
  },
  {
    id: "B1-0164",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "In case you have problems with the device in the future, you should retain your newly _____ receipt.",
    questionVi: "Bạn nên giữ lấy hóa đơn vừa được phát hành, phòng trường hợp bạn gặp phải vấn đề với thiết bị này trong tương lai.",
    options: [
      { option: "expressed", isCorrect: false },
      { option: "predicted", isCorrect: false },
      { option: "issued", isCorrect: true },
      { option: "approached", isCorrect: false },
    ],
    explanationVi:
      "Dịch đáp án:\nA. expressed (v): bày tỏ\nB. predicted (v): dự đoán\nC. issued (v): được phát hành\nD. approached (v): tiếp cận\nPhân tích: Đây là câu về từ vựng nên bạn cần dựa vào nghĩa để đưa ra đáp án chính xác.\nA. chuyển phát\nB. dự đoán\nC. phát hành\nD. tiếp cận\n=> Đáp án đúng là C “issued”.\nDịch câu: Bạn nên giữ lấy hóa đơn vừa được phát hành, phòng trường hợp bạn gặp phải vấn đề với thiết bị này trong tương lai.",
    category: "Grammar",
  },
  {
    id: "B1-0165",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "If the patient's nasal problem does not show signs of improvement _____ two days, he should visit the clinic again.",
    questionVi: "Nếu vấn đề về mũi của bệnh nhân không có dấu hiệu thuyên giảm trong vòng hai ngày, anh ta nên đến khám lại.",
    options: [
      { option: "because of", isCorrect: false },
      { option: "regarding", isCorrect: false },
      { option: "apart from", isCorrect: false },
      { option: "within", isCorrect: true },
    ],
    explanationVi:
      "Dịch đáp án:\nA. because of: bởi vì\nB. regarding: liên quan đến\nC. apart from: ngoài ra\nD. within: trong vòng\nPhân tích: Đây là câu về từ vựng nên bạn cần dựa vào nghĩa để đưa ra đáp án chính xác.\nA. vì, do\nB. liên quan đến\nC. ngoài, không tính\nD. trong vòng\n=> Đáp án đúng là D “within”.\nDịch câu: Nếu vấn đề về mũi của bệnh nhân không có dấu hiệu thuyên giảm trong vòng hai ngày, anh ta nên đến khám lại.",
    category: "Grammar",
  },
  {
    id: "B1-0166",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "Those giving demonstrations at the department store _____ explained the product's features and benefits.",
    questionVi: "Những người giới thiệu tại cửa hàng đã giải thích một cách nhiệt tình những tính năng và ích lợi của sản phẩm.",
    options: [
      { option: "enthusiasm", isCorrect: false },
    ...
    explanationVi:
      "Giải thích: Chỗ trống nằm giữa chủ ngữ và động từ của câu, nên nó chỉ có thể là trạng từ để bổ nghĩa cho động từ --> chọn \"enthusiastically\". Những người giới thiệu tại cửa hàng đã giải thích một cách nhiệt tình những tính năng và ích lợi của sản phẩm.",
    category: "Grammar",
  },
  {
    id: "B1-0167",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "Because its latest exhibit is highly valuable, the Gabe Gallery took more precautions than it _____ did in the past.",
    questionVi: "Vì buổi triển lãm gần đây nhất của Gabe Gallery rất quan trọng, họ đã cẩn trọng với nó hơn tất cả những buổi triển lãm họ đã từng thực hiện trong quá khứ.",
    options: [
      { option: "ever", isCorrect: true },
      { option: "yet", isCorrect: false },
    ...
    explanationVi:
      "Phân tích: Đây là câu về từ vựng nên bạn cần dựa vào nghĩa để đưa ra đáp án chính xác.\nA. đã từng\nB. chưa, nhưng\nC. như vậy\nD. nhiều\n=> Đáp án đúng là A “ever”.\nDịch câu: Vì buổi triển lãm gần đây nhất của Gabe Gallery rất quan trọng, họ đã cẩn trọng với nó hơn tất cả những buổi triển lãm họ đã từng thực hiện trong quá khứ.",
    category: "Grammar",
  },
  {
    id: "B1-0168",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "_____ making structural changes to a house must first apply for a building permit.",
    questionVi: "Bất kỳ ai thực hiện những thay đổi thuộc về cấu trúc của toà nhà trước hết phải nộp đơn xin giấy phép xây dựng.",
    options: [
      { option: "Our", isCorrect: false },
      { option: "Who", isCorrect: false },
      { option: "Them", isCorrect: false },
      { option: "Anyone", isCorrect: true },
    ],
    explanationVi:
      "Giải thích: Dựa vào nghĩa ta chọn \"anyone\". Lưu ý: mặc dù \"who\" có vẻ \"hợp nghĩa\", nhưng không đúng ngữ pháp. Nếu dùng \"who\", câu này phải được viết là \"WHO MAKES structural changes to a house must first apply for a building permit.\" Bất kỳ ai thực hiện những thay đổi thuộc về cấu trúc của toà nhà trước hết phải nộp đơn xin giấy phép xây dựng.",
    category: "Grammar",
  },
  {
    id: "B1-0169",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "Employees who attend the workshop on improving communication skills will be given a certificate of _____ by the instructor.",
    questionVi: "Các nhân viên tham dự buổi hội thảo về cải thiện kỹ năng giao tiếp sẽ được trao một chứng chỉ bởi người hướng dẫn.",
    options: [
      { option: "achieved", isCorrect: false },
      { option: "achieving", isCorrect: false },
      { option: "achieve", isCorrect: false },
      { option: "achievement", isCorrect: true },
    ],
    explanationVi:
      "Giải thích: \"Certificate of achievement\" là một loại bằng chứng nhận người học đã hoàn thành xong một khoá học nào đó. Các nhân viên tham dự buổi hội thảo về cải thiện kỹ năng giao tiếp sẽ được trao một chứng chỉ bởi người hướng dẫn.",
    category: "Grammar",
  },
  {
    id: "B1-0170",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "_____ its distinguished faculty in the science department, the university has state-of-the-art laboratory facilities.",
    questionVi: "Bên cạnh khoa đào tạo nổi tiếng của ban Khoa học, trường đại học này còn có trang thiết bị phòng thí nghiệm vô cùng tiên tiến.",
    options: [
      { option: "In addition to", isCorrect: true },
      { option: "Otherwise", isCorrect: false },
      { option: "As well", isCorrect: false },
      { option: "Hardly ever", isCorrect: false },
    ],
    explanationVi:
      "Dịch đáp án:\nA. In addition to: ngoài\nB. Otherwise: mặt khác\nC. As well: cũng vậy\nD. Hardly ever: hầu như không bao giờ\nPhân tích: Đây là câu về từ vựng nên bạn cần dựa vào nghĩa để đưa ra đáp án chính xác.\nA. thêm vào, bên cạnh\nB. nếu không thì\nC. cũng vậy, cũng thế\nD. gần như không bao giờ\n=> Đáp án đúng là A “In addition to”.\nDịch câu: Bên cạnh khoa đào tạo nổi tiếng của ban Khoa học, trường đại học này còn có trang thiết bị phòng thí nghiệm vô cùng tiên tiến.",
    category: "Grammar",
  },
  {
    id: "B1-0171",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The donations received from the fundraiser _____ among the charity's three locations equally.",
    questionVi: "Số tiền quyên góp nhận được từ người gây quỹ sẽ được chia đều cho cả ba địa điểm của quỹ từ thiện.",
    options: [
      { option: "have divided", isCorrect: false },
      { option: "is being divided", isCorrect: false },
      { option: "are dividing", isCorrect: false },
      { option: "will be divided", isCorrect: true },
    ],
    explanationVi:
      "Giải thích: Tiền quyên góp thì không thể tự nó \"chia ra\" được, mà phải \"được chia ra\" --> chọn động từ bị động --> \"is being divided\" hoặc \"will be devided\". Chủ ngữ của câu này \"the donations\", danh từ số nhiều, nên động từ không thể chia là \"is\" được --> chỉ có thể chọn \"will be divided\". Số tiền quyên góp nhận được từ người gây quỹ sẽ được chia đều cho cả ba địa điểm của quỹ từ thiện.",
    category: "Grammar",
  },
  {
    id: "B1-0172",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "_____ the building's age, the ventilation system must be up-to-date with all safety codes.",
    questionVi: "Không kể đến số tuổi của tòa nhà, hệ thống thông gió phải được cập nhật cùng với tất cả các mã an toàn.",
    options: [
      { option: "Instead of", isCorrect: false },
      { option: "Toward", isCorrect: false },
      { option: "Regardless of", isCorrect: true },
      { option: "Since", isCorrect: false },
    ],
    explanationVi:
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The train delays on the Trenton line were caused by a _____ error at one of the stations.",
    questionVi: "Sự chậm trễ tàu trên tuyến Trenton đã bị gây ra bởi một lỗi sai tại một trong số các nhà ga.",
    options: [
      { option: "proceed", isCorrect: false },
      { option: "proceeded", isCorrect: false },
      { option: "procedural", isCorrect: true },
      { option: "procedurally", isCorrect: false },
    ],
    explanationVi:
      "Giải thích: Chỗ trống nằm giữa một mạo từ (a) và một danh từ (error) nên chắc chắn phải là một từ có thể bổ nghĩa cho danh từ đó --> trong các lựa chọn, chỉ có thể chọn tính từ \"procedural\". Sự chậm trễ tàu trên tuyến Trenton đã bị gây ra bởi một lỗi sai tại một trong số các nhà ga.",
    category: "Grammar",
  },
  {
    id: "B1-0174",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "As we expect to receive hundreds of applications for the position, please _____ your resume to two pages.",
    questionVi: "Vì chúng tôi sẽ nhận được hàng trăm đơn ứng cử cho vị trí này, bạn hãy giới hạn bản sơ yếu lý lịch của mình trong độ dài hai trang giấy.",
    options: [
      { option: "limit", isCorrect: true },
      { option: "follow", isCorrect: false },
      { option: "refrain", isCorrect: false },
      { option: "unfold", isCorrect: false },
    ],
    explanationVi:
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The lecturer _____ on the country's struggle for independence when he gives his talk.",
    questionVi: "Giảng viên sẽ tập trung vào cuộc đấu tranh giành độc lập của đất nước khi ông ấy giảng giải.",
    options: [
      { option: "has focused", isCorrect: false },
      { option: "is focused", isCorrect: false },
      { option: "will focus", isCorrect: true },
      { option: "focusing", isCorrect: false },
    ],
    explanationVi:
      "Giải thích: Chủ ngữ \"the lecturer\" chưa có động từ chia thì của nó --> cần điền động từ chia thì --> loại \"focusing\". Dựa vào nghĩa, loại bị động \"is focused\". Động từ \"gives\" trong \"When he gives his talk\" cho thấy hành động \"gives\" xảy ra trong tương lai, vì vậy hành động \"focus\" cũng phải xảy ra trong tương lai --> chọn \"will focus\". Giảng viên sẽ tập trung vào cuộc đấu tranh giành độc lập của đất nước khi ông ấy giảng giải.",
    category: "Grammar",
  },
  {
    id: "B1-0176",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The welcome activity is an opportunity to improve communication _____ volunteers before the project begins.",
    questionVi: "Hoạt động chào mừng là một cơ hội để cải thiện sự giao tiếp giữa các tình nguyện viên trước khi dự án bắt đầu.",
    options: [
      { option: "among", isCorrect: true },
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The balconies connected to the rooms at the Orwell Hotel provide a _____ view of a private beach.",
    questionVi: "Các ban công nối với các phòng ở Khách sạn Orwell cung cấp một góc nhìn tuyệt đẹp ra bãi biển riêng.",
    options: [
      { option: "stunningly", isCorrect: false },
      { option: "stuns", isCorrect: false },
      { option: "stunning", isCorrect: true },
      { option: "stunned", isCorrect: false },
    ],
    explanationVi:
      "Giải thích: Chỗ trống đứng sau một mạo từ (a) và đứng trước một danh từ (view) nên nó chắc chắn là một từ có thể bổ nghĩa cho danh từ --> chọn tính từ \"stunning\". Các ban công nối với các phòng ở Khách sạn Orwell cung cấp một góc nhìn tuyệt đẹp ra bãi biển riêng.",
    category: "Grammar",
  },
  {
    id: "B1-0178",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The travel agent's _____ of the ticket purchase was sent to the customer by e-mail as soon as the payment was made.",
    questionVi: "Xác nhận mua vé của đại lý du lịch đã được gửi đến cho khách hàng qua email ngay khi hoàn thành việc thanh toán.",
    options: [
      { option: "extent", isCorrect: false },
      { option: "confirmation", isCorrect: true },
      { option: "awareness", isCorrect: false },
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "After examining the vehicle, the mechanic had _____ identified the reason why the engine lost power.",
    questionVi: "",
    options: [
      { option: "corrections", isCorrect: false },
      { option: "correctly", isCorrect: true },
      { option: "correct", isCorrect: false },
      { option: "corrects", isCorrect: false },
    ],
    explanationVi:
      "Giải thích: Chỗ trống nằm chen giữa cấu trúc của thì quá khứ hoàn thành (had identified) nên nó phải là trạng từ --> chọn trạng từ \"correctly\". Sau khi kiểm tra chiếc xe, người thợ sửa xe đã xác định chính xác lý do vì sao động cơ mất nguồn.",
    category: "Grammar",
  },
  {
    id: "B1-0180",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "Because of her hearing disability, Ms. Frasier will be _____ by a sign language expert so she can participate in the meeting.",
    questionVi: "Vì bị khiếm thính, Ms. Frasier sẽ được đồng hành bởi một chuyên gia ngôn ngữ ký hiệu để cô ấy có thể tham gia hội thảo.",
    options: [
      { option: "convinced", isCorrect: false },
      { option: "anticipated", isCorrect: false },
      { option: "accompanied", isCorrect: true },
      { option: "cautioned", isCorrect: false },
    ],
    explanationVi:
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The project development team is partially responsible for the selection and _____ of potential building sites.",
    questionVi: "Đội phát triển dự án tham gia một phần trách nhiệm đối với việc lựa chọn và việc đánh giá các địa điểm xây dựng tiềm năng.",
    options: [
      { option: "appraisal", isCorrect: true },
      { option: "appraises", isCorrect: false },
      { option: "appraise", isCorrect: false },
      { option: "appraised", isCorrect: false },
    ],
    explanationVi:
      "Giải thích: Liên từ \"and\" ở đây đang kết nối danh từ \"selection\" và chỗ trống --> chỗ trống cũng phải là danh từ để nhất quán --> chọn danh từ \"appraisal\". Đội phát triển dự án tham gia một phần trách nhiệm đối với việc lựa chọn và việc đánh giá các địa điểm xây dựng tiềm năng.",
    category: "Grammar",
  },
  {
    id: "B1-0182",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The easy-to-prepare meal packets come with all the ingredients necessary for an individual dinner _____ boiling water.",
    questionVi: "Gói bữa ăn dễ dàng chuẩn bị gồm có tất cả những nguyên liệu cần thiết cho bữa tối của một người ăn, trừ nước sôi.",
    options: [
      { option: "except", isCorrect: true },
      { option: "despite", isCorrect: false },
      { option: "elsewhere", isCorrect: false },
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The education center provides training classes in key skills _____ that the unemployed can find jobs more easily.",
    questionVi: "Trung tâm giáo dục cung cấp các lớp đào tạo những kỹ năng quan trọng mà người thất nghiệp có thể tìm được việc làm dễ dàng hơn.",
    options: [
      { option: "so", isCorrect: true },
      { option: "ever", isCorrect: false },
    ...
    explanationVi:
      "Giải thích: \"So\" có nghĩa là \"nên\", nhưng \"so that\" có nghĩa là \"để mà\". Trung tâm giáo dục cung cấp các lớp đào tạo những kỹ năng quan trọng mà người thất nghiệp có thể tìm được việc làm dễ dàng hơn.",
    category: "Grammar",
  },
  {
    id: "B1-0184",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The terms of the licensing agreement are quite _____ and do not require legal experience to be understood.",
    questionVi: "Những điều khoản của thỏa thuận cấp phép khá dễ hiểu và không cần phải có kiến thức về luật pháp mới hiểu được.",
    options: [
      { option: "energetic", isCorrect: false },
      { option: "frequent", isCorrect: false },
      { option: "straightforward", isCorrect: true },
      { option: "accomplished", isCorrect: false },
    ],
    explanationVi:
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The informational materials sent to conference attendees _____ the presentation schedule and social events.",
    questionVi: "Những tài liệu thông tin được gửi đến cho người tham gia hội nghị tóm lược lịch trình thuyết trình và các sự kiện xã hội.",
    options: [
      { option: "expand", isCorrect: false },
      { option: "solicit", isCorrect: false },
      { option: "allow", isCorrect: false },
      { option: "outline", isCorrect: true },
    ],
    explanationVi:
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "You may have the merchandise sent directly to your home or pick it up in person at the store, _____ you prefer.",
    questionVi: "Bạn có thể chọn gửi hàng trực tiếp đến nhà hoặc tự mình đến lấy tại cửa hàng, bất cứ cái nào tùy bạn chọn.",
    options: [
      { option: "both", isCorrect: false },
      { option: "whichever", isCorrect: true },
      { option: "everybody", isCorrect: false },
      { option: "another", isCorrect: false },
    ],
    explanationVi:
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "_____ occurring substances are used in the vitamin supplement instead of chemicals.",
    questionVi: "Các chất có trong tự nhiên được dùng trong sản phẩm bổ sung vitamin này thay vì hoá chất.",
    options: [
      { option: "Naturally", isCorrect: true },
      { option: "Natural", isCorrect: false },
      { option: "Naturalize", isCorrect: false },
      { option: "Nature", isCorrect: false },
    ],
    explanationVi:
      "Giải thích: Ta cần một trạng từ để bổ nghĩa cho \"occurring\" --> chọn \"naturally\". Các chất có trong tự nhiên được dùng trong sản phẩm bổ sung vitamin này thay vì hoá chất.",
    category: "Grammar",
  },
  {
    id: "B1-0188",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The bus driver used a side street rather than the main highway, _____ avoiding rush hour traffic.",
    questionVi: "Tài xế xe buýt đã sử dụng con phố ngang để đi thay vì đường cao tốc chính, nhờ vậy đã tránh được giao thông đông đúc vào giờ cao điểm.",
    options: [
      { option: "such as", isCorrect: false },
  ...
  },
  {
    ...
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "The crew members _____ the main section of the building by the time the waste removal trucks arrive at 3:",
    questionVi: "Đội ngũ thợ sẽ phá dỡ xong phần chính của toà nhà trước khi những chiếc xe chở phế liệu đến lúc 3 giờ 30.",
    options: [
      { option: "demolish", isCorrect: false },
      { option: "will have demolished", isCorrect: true },
      { option: "demolished", isCorrect: false },
      { option: "had demolished", isCorrect: false },
    ],
    explanationVi:
      "Giải thích: Chúng ta nhận thấy hành động \"demolish\" hoàn thành xong trước một hành động khác trong tương lai (by the time the waste removal trucks arrive at 3:30) --> cần dùng thì tương lai hoàn thành. Đội ngũ thợ sẽ phá dỡ xong phần chính của toà nhà trước khi những chiếc xe chở phế liệu đến lúc 3 giờ 30.",
    category: "Grammar",
  },
  {
    id: "B1-0190",
    topicId: "new-questions",
    questionType: "grammar",
    questionEn: "Should you find any manufacturing _____ in your ultra-high-definition television, contact the place of purchase as soon as possible.",
    questionVi: "Nếu thấy bất kỳ lỗi sản xuất nào trên chiếc tivi độ nét cao của mình, bạn hãy liên hệ với nơi mua hàng sớm nhất có thể.",
    options: [
      { option: "premises", isCorrect: false },
      { option: "defects", isCorrect: true },
      { option: "impacts", isCorrect: false },
