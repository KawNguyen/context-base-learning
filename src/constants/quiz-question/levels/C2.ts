...
export const questions: Question[] = [
  ...
  },
  {
    ...
    questionEn: "Not once ____ the CEO hint at the possibility of a merger during the three-hour press conference.",
    questionVi: "Không một lần nào ____ vị CEO gợi ý về khả năng sáp nhập trong cuộc họp báo kéo dài ba giờ.",
    options: [
      { option: "did", isCorrect: true },
      { option: "has", isCorrect: false },
      { option: "had", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "Were the court ____ the contract invalid, the entire project would be thrown into chaos.",
    questionVi: "Nếu tòa án ____ tuyên bố hợp đồng vô hiệu, toàn bộ dự án sẽ rơi vào tình trạng hỗn loạn.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The startup managed to secure funding ____ the overwhelmingly negative economic forecasts.",
    questionVi: "Công ty khởi nghiệp đã xoay xở để đảm bảo nguồn vốn ____ những dự báo kinh tế cực kỳ tiêu cực.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The terms ____ we ultimately agreed were far more favorable than we had initially anticipated.",
    questionVi: "Các điều khoản ____ mà cuối cùng chúng tôi đã đồng ý thuận lợi hơn nhiều so với dự tính ban đầu.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The effectiveness of the new policy is ____ dependent on the cooperation of regional managers.",
    questionVi: "Hiệu quả của chính sách mới phụ thuộc một cách ____ vào sự hợp tác của các nhà quản lý khu vực.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Not once ____ the CEO fail to acknowledge the contributions of the junior staff during the annual gala.",
    questionVi: "Không một lần nào ____ vị CEO quên ghi nhận sự đóng góp của các nhân viên cấp dưới trong buổi dạ tiệc hàng năm.",
    options: [
      { option: "did", isCorrect: true },
      { option: "does", isCorrect: false },
      { option: "had", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "It is stipulated in the agreement that each partner ____ a detailed account of their expenses every quarter.",
    questionVi: "Trong thỏa thuận quy định rằng mỗi đối tác ____ một bản kê khai chi tiết các khoản chi tiêu của họ vào mỗi quý.",
    options: [
  ...
  },
  {
    ...
    questionEn: "____ for years on the cutting edge of biotechnology, the company finally announced a breakthrough in gene therapy.",
    questionVi: "____ trong nhiều năm ở vị trí tiên phong của công nghệ sinh học, công ty cuối cùng đã công bố một bước đột phá trong liệu pháp gen.",
    options: [
  ...
  },
  {
    ...
    questionEn: "If the firm had not diversified into artificial intelligence a decade ago, it ____ the market leader it is today.",
    questionVi: "Nếu công ty không đa dạng hóa sang lĩnh vực trí tuệ nhân tạo một thập kỷ trước, họ ____ đã không trở thành người dẫn đầu thị trường như ngày nay.",
    options: [
  ...
  },
  {
    ...
    questionEn: "It was his unwavering commitment to ethical practices ____ built the foundation for the company's long-term reputation.",
    questionVi: "Chính sự cam kết kiên định với các thực hành đạo đức của ông ấy ____ đã xây dựng nền tảng cho danh tiếng lâu dài của công ty.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The report outlines several strategies, the effectiveness of ____ remains to be seen in the coming fiscal year.",
    questionVi: "Báo cáo phác thảo một số chiến lược, hiệu quả của ____ vẫn còn phải chờ xem trong năm tài chính tới.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The upcoming merger ____ to be the most significant event in the telecommunications industry this decade.",
    questionVi: "Vụ sáp nhập sắp tới ____ được cho là sự kiện quan trọng nhất trong ngành viễn thông thập kỷ này.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The more the R&D team pushed the boundaries of nanotechnology, ____ the potential applications for medical treatment became.",
    questionVi: "Nhóm R&D càng đẩy mạnh giới hạn của công nghệ nano, các ứng dụng tiềm năng cho điều trị y tế ____.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Access to the high-security server is strictly contingent ____ the submission of a valid security clearance certificate.",
    questionVi: "Việc truy cập vào máy chủ bảo mật cao phụ thuộc hoàn toàn ____ vào việc nộp chứng chỉ kiểm tra an ninh hợp lệ.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Her ____ and profound understanding of international trade laws made her an indispensable asset to the firm.",
    questionVi: "Sự thấu hiểu ____ và sâu sắc của bà ấy về luật thương mại quốc tế đã khiến bà trở thành một tài sản không thể thiếu của công ty.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Under no circumstances ____ any employee be permitted to divulge proprietary source code to outside contractors.",
    questionVi: "Trong bất kỳ hoàn cảnh nào, không một nhân viên nào ____ được phép tiết lộ mã nguồn độc quyền cho các nhà thầu bên ngoài.",
    options: [
  ...
  },
  {
    ...
    questionEn: "____ to circumvent the increasing regulatory hurdles, the multinational corporation revamped its global tax strategy.",
    questionVi: "____ tìm cách lách qua các rào cản quản lý ngày càng tăng, tập đoàn đa quốc gia đã cải tổ chiến lược thuế toàn cầu của mình.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Were it not for his visionary leadership two decades ago, the company ____ the global powerhouse it is today.",
    questionVi: "Nếu không có sự lãnh đạo có tầm nhìn của ông ấy cách đây hai thập kỷ, công ty ____ đã không trở thành cường quốc toàn cầu như ngày nay.",
    options: [
      { option: "would not be", isCorrect: true },
      { option: "would not have been", isCorrect: false },
      { option: "will not be", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "____ the recent economic downturn, our firm has managed to achieve record-breaking profits in the third quarter.",
    questionVi: "____ sự suy thoái kinh tế gần đây, công ty chúng tôi vẫn đạt được mức lợi nhuận kỷ lục trong quý thứ ba.",
    options: [
      { option: "Notwithstanding", isCorrect: true },
  ...
  },
  {
    ...
    questionEn: "The board of directors suggested that the CEO ____ an emergency meeting to address the hostile takeover bid.",
    questionVi: "Ban giám đốc đề xuất rằng CEO ____ một cuộc họp khẩn cấp để giải quyết nỗ lực thâu tóm thù địch.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The treaty contains numerous complex provisions, several of ____ are expected to be challenged in the international court.",
    questionVi: "Hiệp ước bao gồm nhiều điều khoản phức tạp, một vài ____ trong số đó dự kiến sẽ bị thách thức tại tòa án quốc tế.",
    options: [
      { option: "which", isCorrect: true },
      { option: "that", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "No sooner ____ the news of the merger broken than the company's share price skyrocketed by twenty percent.",
    questionVi: "Ngay khi tin tức về vụ sáp nhập vừa được tung ra ____ thì giá cổ phiếu của công ty đã tăng vọt hai mươi phần trăm.",
    options: [
      { option: "had", isCorrect: true },
      { option: "did", isCorrect: false },
      { option: "was", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "It is imperative that every single transaction ____ meticulously documented to ensure full transparency.",
    questionVi: "Điều cấp thiết là mọi giao dịch đơn lẻ ____ được ghi chép lại một cách tỉ mỉ để đảm bảo sự minh bạch hoàn toàn.",
    options: [
      { option: "be", isCorrect: true },
      { option: "is", isCorrect: false },
      { option: "was", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "____ by the sudden shift in consumer behavior, the marketing departement completely overhauled its annual strategy.",
    questionVi: "____ bởi sự thay đổi đột ngột trong hành vi người tiêu dùng, bộ phận tiếp thị đã cải tổ hoàn toàn chiến lược hàng năm của mình.",
    options: [
  ...
  },
  {
    ...
    questionEn: "If we had secured that patent five years ago, we ____ millions of dollars in licensing fees every year now.",
    questionVi: "Nếu chúng ta đảm bảo được bằng sáng chế đó năm năm trước, chúng ta ____ hàng triệu đô la phí cấp phép mỗi năm vào lúc này.",
    options: [
  ...
  },
  {
    ...
    questionEn: "On no account ____ any employee of this firm engage in insider trading or any other form of market manipulation.",
    questionVi: "Trong bất kỳ hoàn cảnh nào, không một nhân viên nào của công ty này ____ được tham gia vào giao dịch nội gián hoặc bất kỳ hình thức thao túng thị trường nào khác.",
    options: [
      { option: "shall", isCorrect: true },
      { option: "should", isCorrect: true },
      { option: "must", isCorrect: true },
  ...
  },
  {
    ...
    questionEn: "____ a balance between long-term growth and short-term profitability is the primary challenge for modern executives.",
    questionVi: "____ sự cân bằng giữa tăng trưởng dài hạn và lợi nhuận ngắn hạn là thách thức chính đối với các giám đốc điều hành hiện đại.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The board ____ been aware of the impending financial crisis long before the public announcement was made.",
    questionVi: "Ban điều hành ____ chắc chắn đã biết về cuộc khủng hoảng tài chính sắp xảy ra từ lâu trước khi thông báo công khai được đưa ra.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The proposed merger will proceed as planned, ____ any unforeseen legal challenges arise in the interim.",
    questionVi: "Vụ sáp nhập được đề xuất sẽ tiến hành như kế hoạch, ____ trừ khi có bất kỳ thách thức pháp lý không lường trước nào phát sinh trong thời gian tạm thời.",
    options: [
  ...
  },
  {
    ...
    questionEn: "It is vital that all personnel ____ the upcoming safety training session without exception.",
    questionVi: "Điều tối quan trọng là tất cả nhân viên ____ tham gia buổi đào tạo an toàn sắp tới mà không có ngoại lệ.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Not until the arbitration process reached its final stage ____ the parties involved agree to a settlement.",
    questionVi: "Mãi cho đến khi quy trình trọng tài đạt đến giai đoạn cuối cùng ____ các bên liên quan mới đồng ý thỏa thuận.",
    options: [
      { option: "did", isCorrect: true },
      { option: "do", isCorrect: false },
      { option: "had", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "The management consultant recommended that the company ____ its entire supply chain to mitigate geopolitical risks.",
    questionVi: "Cố vấn quản lý đã khuyến nghị rằng công ty ____ lại toàn bộ chuỗi cung ứng của mình để giảm thiểu rủi ro địa chính trị.",
    options: [
  ...
  },
  {
    ...
    questionEn: "____ for a significant increase in market share, the electronics firm launched a multi-million dollar advertising campaign.",
    questionVi: "____ mong sự gia tăng đáng kể về thị phần, công ty điện tử đã khởi động một chiến dịch quảng cáo trị giá hàng triệu đô la.",
    options: [
  ...
  },
  {
    ...
    questionEn: "If the government had not intervened with a bailout package, the national carrier ____ bankrupt by now.",
    questionVi: "Nếu chính phủ không can thiệp bằng một gói cứu trợ, hãng hàng không quốc gia ____ đã phá sản vào lúc này.",
    options: [
  ...
  },
  {
    ...
    questionEn: "It was through his meticulous attention to detail ____ the lead architect ensured the project's structural integrity.",
    questionVi: "Chính nhờ sự chú ý tỉ mỉ đến từng chi tiết của ông ấy ____ mà kiến trúc sư trưởng đã đảm bảo được tính toàn vẹn về cấu trúc của dự án.",
    options: [
      { option: "that", isCorrect: true },
      { option: "which", isCorrect: false },
      { option: "when", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "The CEO addressed the shareholders, many of ____ expressed concerns regarding the company's environmental footprint.",
    questionVi: "CEO đã phát biểu trước các cổ đông, nhiều ____ trong số họ bày tỏ lo ngại về dấu chân môi trường của công ty.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Entrepreneurship ____ as a high-risk, high-reward endeavor by most financial analysts.",
    questionVi: "Khởi nghiệp ____ được coi là một nỗ lực có rủi ro cao, lợi nhuận cao bởi hầu hết các nhà phân tích tài chính.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The new automation system works ____ more efficiently than the manual processes it replaced.",
    questionVi: "Hệ thống tự động hóa mới hoạt động ____ hiệu quả hơn nhiều so với các quy trình thủ công mà nó thay thế.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Promotion to a senior management level is often dependent ____ a candidate's ability to demonstrate strategic vision.",
    questionVi: "Việc thăng tiến lên cấp quản lý cấp cao thường phụ thuộc ____ vào khả năng thể hiện tầm nhìn chiến lược của ứng viên.",
    options: [
      { option: "upon", isCorrect: true },
      { option: "to", isCorrect: false },
      { option: "at", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "The legal counsel provided a highly ____ and persuasive argument in favor of the defendant.",
    questionVi: "Cố vấn pháp lý đã đưa ra một lập luận cực kỳ ____ và đầy thuyết phục có lợi cho bị cáo.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Seldom ____ such a high level of cooperation between rival firms in the pharmaceutical industry.",
    questionVi: "Hiếm khi ____ thấy mức độ hợp tác cao như vậy giữa các công ty đối thủ trong ngành dược phẩm.",
    options: [
  ...
  },
  {
    ...
    questionEn: "____ an effective balance between professional obligations and personal well-being is a constant struggle for many executives.",
    questionVi: "____ sự cân bằng hiệu quả giữa các nghĩa vụ nghề nghiệp và hạnh phúc cá nhân là một cuộc đấu tranh không ngừng đối với nhiều giám đốc điều hành.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The company ____ conducted a more thorough market analysis before launching such a specialized product.",
    questionVi: "Công ty ____ lẽ ra nên thực hiện một phân tích thị trường kỹ lưỡng hơn trước khi tung ra một sản phẩm chuyên dụng như vậy.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Company A focused on rapid expansion, ____ Company B prioritized long-term sustainability and organic growth.",
    questionVi: "Công ty A tập trung vào việc mở rộng nhanh chóng, ____ trong khi đó Công ty B ưu tiên sự bền vững lâu dài và tăng trưởng hữu cơ.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The marketing director suggested that the team ____ a more targeted approach to reach high-net-worth individuals.",
    questionVi: "Giám đốc tiếp thị đề xuất rằng nhóm ____ một cách tiếp cận tập trung hơn để tiếp cận những cá nhân có giá trị tài sản ròng cao.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Candidates ____ experience in emerging markets will be given preferential consideration for the international assignment.",
    questionVi: "Các ứng viên ____ có kinh nghiệm tại các thị trường mới nổi sẽ được ưu tiên xem xét cho nhiệm vụ quốc tế.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The details of the proprietary algorithm ____ to remain confidential for a period of ten years.",
    questionVi: "Các chi tiết của thuật toán độc quyền ____ được yêu cầu phải giữ bí mật trong thời gian mười năm.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The current antitrust case is significantly ____ more complex than the previous litigation against the same corporation.",
    questionVi: "Vụ kiện chống độc quyền hiện tại ____ phức tạp hơn đáng kể so với vụ kiện tụng trước đó đối với cùng một tập đoàn.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Employees with over twenty years of service are exempt ____ the mandatory annual training sessions.",
    questionVi: "Nhân viên có trên hai mươi năm công tác được miễn ____ các buổi đào tạo hàng năm bắt buộc.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The company fosters a highly ____ and innovative environment that encourages out-of-the-box thinking.",
    questionVi: "Công ty thúc đẩy một môi trường năng động và ____ sáng tạo cao, khuyến khích tư duy đột phá.",
    options: [
  ...
  },
  {
    ...
    contextEn: "Emphasizing a restriction in formal guidelines.",
    contextVi: "Nhấn mạnh một hạn chế trong hướng dẫn trang trọng.",
    questionEn: "On no account ____ any unauthorized personnel gain access to the secure data repository.",
    questionVi: "Trong bất kỳ hoàn cảnh nào, không một nhân viên không có thẩm quyền nào ____ được quyền truy cập vào kho lưu trữ dữ liệu an toàn.",
    options: [
      { option: "must", isCorrect: true },
      { option: "should", isCorrect: true },
      { option: "shall", isCorrect: true },
  ...
  },
  {
    ...
    questionEn: "It is essential that a leader ____ a high degree of emotional intelligence to effectively manage a diverse team.",
    questionVi: "Điều thiết yếu là một nhà lãnh đạo ____ mức độ trí tuệ cảm xúc cao để quản lý hiệu quả một nhóm đa dạng.",
    options: [
  ...
  },
  {
    ...
    questionEn: "____ by the lack of transparency in the financial reports, the investors withdrew their support for the merger.",
    questionVi: "____ bởi sự thiếu minh bạch trong các báo cáo tài chính, các nhà đầu tư đã rút lại sự ủng hộ của họ đối với vụ sáp nhập.",
    options: [
  ...
  },
  {
    ...
    questionEn: "If we had invested more in digital transformation years ago, we ____ such a significant disadvantage today.",
    questionVi: "Nếu chúng ta đầu tư nhiều hơn vào chuyển đổi số từ nhiều năm trước, chúng ta ____ đã không ở trong tình thế bất lợi đáng kể như hiện nay.",
    options: [
  ...
  },
  {
    ...
    questionEn: "It was exactly this shift in consumer mentality ____ the marketing team failed to anticipate in their annual forecast.",
    questionVi: "Chính xác là sự thay đổi trong tâm lý người tiêu dùng này ____ mà nhóm tiếp thị đã không lường trước được trong dự báo hàng năm của họ.",
    options: [
      { option: "that", isCorrect: true },
      { option: "which", isCorrect: false },
      { option: "when", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "Not until the external audit was thoroughly completed ____ the board of directors release the annual financial report.",
    questionVi: "Mãi cho đến khi cuộc kiểm toán bên ngoài được hoàn thành kỹ lưỡng ____ ban giám đốc mới công bố báo cáo tài chính hàng năm.",
    options: [
      { option: "did", isCorrect: true },
      { option: "do", isCorrect: false },
      { option: "had", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "The strategic consultant recommended that the firm ____ its entire marketing strategy to better align with digital trends.",
    questionVi: "Cố vấn chiến lược đã khuyến nghị rằng công ty ____ lại toàn bộ chiến lược tiếp thị của mình để phù hợp hơn với các xu hướng kỹ thuật số.",
    options: [
      { option: "overhaul", isCorrect: true },
      { option: "overhauls", isCorrect: false },
      { option: "overhauled", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "____ for a breakthrough in renewable energy technology, the research team worked tirelessly for several years.",
    questionVi: "____ mong tìm kiếm bước đột phá trong công nghệ năng lượng tái tạo, nhóm nghiên cứu đã làm việc không mệt mỏi trong vài năm.",
    options: [
      { option: "Striving", isCorrect: true },
      { option: "Strived", isCorrect: false },
      { option: "Having strived", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "If the company had not ignored the initial warnings, it ____ such severe legal consequences today.",
    questionVi: "Nếu công ty không phớt lờ những cảnh báo ban đầu, họ ____ đã không phải đối mặt với những hệ quả pháp lý nghiêm trọng như hiện nay.",
    options: [
  ...
  },
  {
    ...
    questionEn: "It was their exceptional ability to adapt to local customs ____ allowed the firm to succeed in the Middle Eastern market.",
    questionVi: "Chính khả năng thích nghi đặc biệt với các phong tục địa phương của họ ____ đã cho phép công ty thành công tại thị trường Trung Đông.",
    options: [
      { option: "that", isCorrect: true },
      { option: "which", isCorrect: false },
      { option: "when", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "The white paper discusses several emerging technologies, the long-term impact of ____ remains highly speculative.",
    questionVi: "Sách trắng thảo luận về một số công nghệ mới nổi, tác động dài hạn của ____ vẫn còn mang tính suy đoán cao.",
    options: [
      { option: "which", isCorrect: true },
      { option: "that", isCorrect: false },
      { option: "whose", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "The demand for skilled cybersecurity professionals ____ to grow exponentially over the next decade.",
    questionVi: "Nhu cầu về các chuyên gia bảo mật mạng có tay nghề ____ dự kiến sẽ tăng theo cấp số nhân trong thập kỷ tới.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The larger the economies of scale, ____ the per-unit cost of production becomes.",
    questionVi: "Lợi thế kinh tế theo quy mô càng lớn, chi phí sản xuất trên mỗi đơn vị ____.",
    options: [
  ...
  },
  {
    ...
    questionEn: "Eligibility for the research grant is strictly contingent ____ providing a detailed breakdown of the proposed budget.",
    questionVi: "Việc đủ điều kiện nhận tài trợ nghiên cứu phụ thuộc hoàn toàn ____ vào việc cung cấp bản kê khai chi tiết ngân sách đề xuất.",
    options: [
      { option: "upon", isCorrect: true },
      { option: "to", isCorrect: false },
      { option: "for", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "The current geopolitical climate is extremely ____ and requires a cautious approach to international investment.",
    questionVi: "Khí hậu địa chính trị hiện nay cực kỳ ____ và đòi hỏi một cách tiếp cận thận trọng đối với đầu tư quốc tế.",
    options: [
  ...
  },
  {
    ...
    contextEn: "Emphasizing a restriction in formal guidelines.",
    contextVi: "Nhấn mạnh một hạn chế trong hướng dẫn trang trọng.",
    questionEn: "Under no circumstances ____ any employee be allowed to share sensitive customer data with third-party vendors without prior authorization.",
    questionVi: "Trong bất kỳ hoàn cảnh nào, không một nhân viên nào ____ được phép chia sẻ dữ liệu khách hàng nhạy cảm với các nhà cung cấp bên thứ ba mà không có sự cho phép trước.",
    options: [
      { option: "shall", isCorrect: true },
      { option: "should", isCorrect: true },
      { option: "must", isCorrect: true },
  ...
  },
  {
    ...
    questionEn: "____ an effective balance between corporate social responsibility and profitability is a key priority for the new CEO.",
    questionVi: "____ sự cân bằng hiệu quả giữa trách nhiệm xã hội của doanh nghiệp và lợi nhuận là ưu tiên chính của vị CEO mới.",
    options: [
  ...
  },
  {
    ...
    questionEn: "The board ____ been aware of the potential risks long before the project was actually launched.",
    questionVi: "Ban điều hành ____ chắc chắn đã biết về những rủi ro tiềm ẩn từ lâu trước khi dự án thực sự được khởi xướng.",
    options: [
      { option: "must have", isCorrect: true },
      { option: "should have", isCorrect: false },
      { option: "could have", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "____ the recent market fluctuations, our firm has maintained a steady growth trajectory throughout the year.",
    questionVi: "____ những biến động thị trường gần đây, công ty chúng tôi vẫn duy trì quỹ đạo tăng trưởng ổn định trong suốt cả năm.",
    options: [
      { option: "Notwithstanding", isCorrect: true },
      { option: "Although", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "The steering committee recommended that the project ____ terminated immediately due to budget overruns.",
    questionVi: "Ủy ban điều hành đã khuyến nghị rằng dự án ____ dừng lại ngay lập tức do vượt quá ngân sách.",
    options: [
      { option: "be", isCorrect: true },
      { option: "is", isCorrect: false },
      { option: "was", isCorrect: false },
  ...
  },
  {
    ...
    contextEn: "Adding information with a complex relative clause.",
    contextVi: "Thêm thông tin bằng mệnh đề quan hệ phức tạp.",
    questionEn: "The merger involves several complex legal entities, many of ____ are based in offshore jurisdictions.",
    questionVi: "Vụ sáp nhập liên quan đến một số pháp nhân phức tạp, nhiều ____ trong số đó có trụ sở tại các khu vực pháp lý ngoài khơi.",
    options: [
      { option: "which", isCorrect: true },
      { option: "that", isCorrect: false },
      { option: "whom", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "No sooner ____ the new CEO taken office than he initiated a series of radical organizational reforms.",
    questionVi: "Vị CEO mới vừa nhận chức ____ thì ông ấy đã bắt đầu một loạt các cuộc cải cách tổ chức triệt để.",
    options: [
      { option: "had", isCorrect: true },
      { option: "did", isCorrect: false },
      { option: "was", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "It is imperative that every proposal ____ carefully vetted by the legal department before being submitted to the board.",
    questionVi: "Điều cấp thiết là mọi đề xuất ____ được bộ phận pháp lý kiểm tra kỹ lưỡng trước khi trình ban giám đốc.",
    options: [
      { option: "be", isCorrect: true },
      { option: "is", isCorrect: false },
      { option: "was", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "____ by the ongoing volatility in the domestic market, the company decided to focus more on international expansion.",
    questionVi: "____ bởi sự biến động đang diễn ra ở thị trường trong nước, công ty đã quyết định tập trung nhiều hơn vào việc mở rộng quốc tế.",
    options: [
  ...
  },
  {
    ...
    questionEn: "If the firm had not invested heavily in R&D, it ____ its current competitive edge in the global market.",
    questionVi: "Nếu công ty không đầu tư mạnh vào R&D, họ ____ đã không có được lợi thế cạnh tranh như hiện nay trên thị trường toàn cầu.",
    options: [
  ...
  },
  {
    ...
    questionEn: "It was exactly this innovative approach to customer service ____ set the startup apart from its established competitors.",
    questionVi: "Chính xác là cách tiếp cận sáng tạo trong dịch vụ khách hàng này ____ đã làm cho công ty khởi nghiệp khác biệt so với các đối thủ cạnh tranh lâu đời.",
    options: [
      { option: "that", isCorrect: true },
      { option: "which", isCorrect: false },
      { option: "when", isCorrect: false },
  ...
  },
  {
    ...
    contextEn: "Emphasizing a restriction in formal guidelines.",
    contextVi: "Nhấn mạnh một hạn chế trong hướng dẫn trang trọng.",
    questionEn: "On no account ____ any unauthorized person gain access to the company's proprietary data repository.",
    questionVi: "Trong bất kỳ hoàn cảnh nào, không một cá nhân không có thẩm quyền nào ____ được quyền truy cập vào kho dữ liệu độc quyền của công ty.",
    options: [
      { option: "must", isCorrect: true },
      { option: "should", isCorrect: true },
      { option: "shall", isCorrect: true },
  ...
  },
  {
    ...
    questionEn: "It is essential that a successful candidate ____ outstanding communication and leadership skills.",
    questionVi: "Điều thiết yếu là một ứng viên thành công ____ các kỹ năng lãnh đạo và giao tiếp xuất sắc.",
    options: [
      { option: "possess", isCorrect: true },
      { option: "possesses", isCorrect: false },
      { option: "possessed", isCorrect: false },
  ...
  },
  {
    ...
    questionEn: "____ by the unexpected shift in consumer behavior, the marketing department decided to completely revamp its strategy.",
    questionVi: "____ bởi sự thay đổi bất ngờ trong hành vi người tiêu dùng, bộ phận tiếp thị đã quyết định cải tổ hoàn toàn chiến lược của mình.",
    options: [
      { option: "Surprised", isCorrect: true },
      { option: "Surprising", isCorrect: false },
      { option: "To be surprised", isCorrect: false },
