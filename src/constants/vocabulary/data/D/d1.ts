...
export const D1: VocabularyWord[] = [
  ...
  },
  {
    ...
    partOfSpeech: "noun",
    meaningEn:
      "Decentralized Autonomous Organization: an organization represented by rules encoded as a computer program, controlled by its members.",
    meaningVi:
      "Tổ chức tự trị phi tập trung: tổ chức có quy tắc được mã hóa dưới dạng chương trình, do các thành viên kiểm soát.",
