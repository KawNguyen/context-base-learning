...
export const I1: VocabularyWord[] = [
  ...
  },
  {
    ...
    exampleEn:
      "Processing a massive PDF library requires an immense amount of computational power. / The dataset for driver drowsiness detection provides an immense variety of facial angles.",
    exampleVi:
      "Xử lý một thư viện PDF đồ sộ đòi hỏi một lượng sức mạnh tính toán cực kỳ lớn. / Tập dữ liệu cho việc phát hiện buồn ngủ của tài xế cung cấp một sự đa dạng khổng lồ về các góc mặt.",
  ...
  },
  {
    ...
    exampleEn:
      "The optimized vector index improved the chatbot's response speed immensely. / Refactoring the memory allocator helped immensely in stabilizing the application.",
    exampleVi:
      "Chỉ mục vector được tối ưu hóa đã cải thiện tốc độ phản hồi của chatbot một cách cực kỳ nhiều. / Việc cấu trúc lại bộ cấp phát bộ nhớ đã giúp ích hết sức nhiều trong việc làm ổn định ứng dụng.",
  ...
  },
  {
    ...
    exampleEn:
      "The immensity of the vector database space can make strict keyword searching inefficient. / Developers are often overwhelmed by the immensity of legacy codebases.",
    exampleVi:
      "Sự bao la của không gian cơ sở dữ liệu vector có thể khiến việc tìm kiếm từ khóa chính xác trở nên kém hiệu quả. / Các lập trình viên thường bị choáng ngợp bởi tính khổng lồ của các kho mã nguồn cũ.",
