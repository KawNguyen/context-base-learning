...
export const T2: VocabularyWord[] = [
  ...
  },
  {
    ...
    meaningEn: "The highest or uppermost part.",
    meaningVi: "Đỉnh.",
    exampleEn: "Mountain top.",
    exampleVi: "Đỉnh núi.",
    categories: ["General"],
  },
  {
    ...
    phonetic: "/ˈtɑː.pɪk/",
    partOfSpeech: "noun",
    meaningEn: "A matter dealt with in a text.",
    meaningVi: "Chủ đề.",
  ...
  },
  {
    ...
    meaningEn: "Comprising the whole number or amount.",
    meaningVi: "Tổng cộng.",
  ...
  },
  {
    ...
    partOfSpeech: "adverb",
    meaningEn: "Completely; absolutely.",
    meaningVi: "Hoàn toàn.",
    exampleEn: "Totally agree.",
    exampleVi: "Hoàn toàn đồng ý.",
    categories: ["General"],
  },
  {
    id: "gen-1601",
    ...
    meaningEn: "Come into or be in contact with.",
    meaningVi: "Chạm.",
    exampleEn: "Don't touch.",
    exampleVi: "Đừng chạm vào.",
    categories: ["General"],
  },
  {
    id: "gen-1602",
    ...
    meaningEn: "Strong enough to withstand adverse conditions.",
    meaningVi: "Khó khăn.",
    exampleEn: "Tough decision.",
    exampleVi: "Quyết định khó khăn.",
    categories: ["General"],
  },
  {
    id: "gen-1603",
    ...
    meaningEn: "A journey for pleasure in which several places are visited.",
    meaningVi: "Chuyến du lịch.",
    exampleEn: "City tour.",
    exampleVi: "Tour tham quan thành phố.",
    categories: ["Travel"],
  },
  {
    id: "job-0028",
    ...
    phonetic: "/tʊr ɡaɪd/",
    partOfSpeech: "noun",
    meaningEn: "A person who shows tourists around places.",
  ...
  },
  {
    ...
    meaningEn: "In the direction of.",
    meaningVi: "Về phía.",
    exampleEn: "Step toward.",
    exampleVi: "Bước về phía trước.",
    categories: ["General"],
  },
  {
    id: "gen-1606",
    ...
    meaningEn: "In the direction of.",
    meaningVi: "Về phía.",
    exampleEn: "Walk towards.",
    exampleVi: "Đi về phía.",
    categories: ["General"],
  },
  {
    id: "gen-1607",
    ...
    phonetic: "/taʊəl/",
    partOfSpeech: "noun",
    meaningEn: "A piece of absorbent cloth used for drying.",
    meaningVi: "Khăn tắm.",
    exampleEn: "Beach towel.",
    exampleVi: "Khăn tắm biển.",
    categories: ["Home"],
  },
  {
    id: "gen-1608",
    ...
    phonetic: "/ˈtaʊ.ɚ/",
    partOfSpeech: "noun",
    meaningEn: "A tall narrow building.",
    meaningVi: "Tháp.",
  ...
  },
  {
    ...
    phonetic: "/tɔɪ/",
    partOfSpeech: "noun",
    meaningEn: "An object for a child to play with.",
    meaningVi: "Đồ chơi.",
    exampleEn: "Child's toy.",
    exampleVi: "Đồ chơi của trẻ con.",
    categories: ["General"],
  },
  {
    id: "gen-1611",
    ...
    phonetic: "/treɪs/",
    partOfSpeech: "verb/noun",
    meaningEn: "Find or discover by investigation.",
    meaningVi: "Dấu vết.",
    exampleEn: "Trace evidence.",
    exampleVi: "Dấu vết bằng chứng.",
    categories: ["General"],
  },
  {
    id: "gen-1612",
    ...
    phonetic: "/træk/",
    partOfSpeech: "noun/verb",
    meaningEn: "A rough path or road.",
    meaningVi: "Theo dõi.",
    exampleEn: "Race track.",
    exampleVi: "Đường đua.",
    categories: ["General"],
  },
  {
    ...
    partOfSpeech: "noun",
    meaningEn: "(of a person or animal) easy to control or influence.",
  ...
  },
  {
    ...
    phonetic: "/treɪd/",
    partOfSpeech: "noun/verb",
    meaningEn: "The action of buying and selling goods and services.",
  ...
  },
  {
    ...
    phonetic: "/treɪn/",
    partOfSpeech: "noun/verb",
    meaningEn: "A series of connected railway carriages.",
    meaningVi: "Tàu hỏa.",
  ...
  },
  {
    ...
    phonetic: "/ˈtreɪ.nɚ/",
    partOfSpeech: "noun",
    meaningEn: "A person who trains others in skills or fitness.",
  ...
  },
  {
    ...
    phonetic: "/ˈtreɪ.nɪŋ/",
    partOfSpeech: "noun",
    meaningEn: "The action of teaching a person or animal.",
    meaningVi: "Đào tạo.",
  ...
  },
  {
    ...
    partOfSpeech: "verb",
    meaningEn: "Make a thorough or dramatic change.",
    meaningVi: "Biến đổi.",
    exampleEn: "Transform life.",
    exampleVi: "Biến đổi cuộc sống.",
    categories: ["General"],
  },
  {
    id: "b2-225",
  ...
  },
  {
    ...
    partOfSpeech: "noun",
    meaningEn: "The process of changing from one state to another.",
    meaningVi: "Chuyển đổi.",
    exampleEn: "Smooth transition.",
    exampleVi: "Chuyển đổi suôn sẻ.",
    categories: ["General"],
  },
  {
    id: "gen-1621",
    ...
    phonetic: "/trænsˈleɪt/",
    partOfSpeech: "verb",
    meaningEn: "Express the sense of words in another language.",
    meaningVi: "Dịch.",
    exampleEn: "Translate to English.",
    exampleVi: "Dịch sang tiếng Anh.",
  ...
  },
  {
    ...
    partOfSpeech: "noun",
    meaningEn: "The process of translating words.",
    meaningVi: "Bản dịch.",
    exampleEn: "Accurate translation.",
    exampleVi: "Bản dịch chính xác.",
    categories: ["Education"],
  },
  {
    id: "job-0030",
    ...
    partOfSpeech: "noun",
    meaningEn: "A person who translates from one language to another.",
  ...
  },
  {
    ...
    phonetic: "/træp/",
    partOfSpeech: "noun/verb",
    meaningEn: "A device or enclosure designed to catch animals.",
    meaningVi: "Bẫy.",
    exampleEn: "Set a trap.",
    exampleVi: "Đặt bẫy.",
    categories: ["General"],
  },
  {
    ...
    phonetic: "/træʃ/",
    partOfSpeech: "noun/verb",
    meaningEn: "Waste material; to throw away.",
  ...
  },
  {
    ...
    phonetic: "/ˈtræv.əl.ɚ/",
    partOfSpeech: "noun",
    meaningEn: "A person who is traveling.",
    meaningVi: "Khách du lịch.",
  ...
  },
  {
    ...
    phonetic: "/ˈtreʒ.ɚ/",
    partOfSpeech: "noun/verb",
    meaningEn: "A quantity of precious metals.",
    meaningVi: "Kho báu.",
    exampleEn: "Hidden treasure.",
    exampleVi: "Kho báu bị chôn giấu.",
    categories: ["General"],
  },
  {
    id: "gen-1629",
    ...
    phonetic: "/triːt/",
    partOfSpeech: "verb/noun",
    meaningEn: "Behave toward or deal with someone.",
    meaningVi: "Đối xử.",
    exampleEn: "Treat with respect.",
    exampleVi: "Đối xử tôn trọng.",
    categories: ["General"],
  },
  {
    id: "a2-240",
  ...
  },
  {
    ...
    phonetic: "/trend/",
    partOfSpeech: "noun",
    meaningEn: "A general direction in which something is developing.",
    meaningVi: "Xu hướng.",
  ...
  },
  {
    ...
    phonetic: "/traɪəl/",
    partOfSpeech: "noun",
    meaningEn: "A formal examination of evidence.",
  ...
  },
  {
    ...
    partOfSpeech: "noun",
    meaningEn: "A plane figure with three straight sides.",
  ...
  },
  {
    ...
    phonetic: "/trɪk/",
    partOfSpeech: "noun/verb",
    meaningEn: "A cunning or deceitful action.",
    meaningVi: "Mẹo.",
    exampleEn: "Magic trick.",
    exampleVi: "Màn ảo thuật.",
    categories: ["General"],
  },
  {
    id: "gen-1636",
    ...
    phonetic: "/trɪp/",
    partOfSpeech: "noun/verb",
    meaningEn: "A journey or excursion.",
    meaningVi: "Chuyến đi.",
    exampleEn: "Business trip.",
    exampleVi: "Chuyến công tác.",
    categories: ["Travel"],
  },
  {
    id: "gen-1637",
    ...
    phonetic: "/ˈtrʌb.əl/",
    partOfSpeech: "noun/verb",
    meaningEn: "Difficulty or problems.",
    meaningVi: "Rắc rối.",
    exampleEn: "Get into trouble.",
    exampleVi: "Gặp rắc rối.",
    categories: ["General"],
  },
  {
    id: "b1-186",
  ...
  },
  {
    ...
    phonetic: "/trʌk/",
    partOfSpeech: "noun",
    meaningEn: "A large heavy motor vehicle.",
    meaningVi: "Xe tải.",
  ...
  },
  {
    ...
    phonetic: "/ˈtruː.li/",
    partOfSpeech: "adverb",
    meaningEn: "In a truthful way.",
    meaningVi: "Thực sự.",
    exampleEn: "Truly yours.",
    exampleVi: "Kính thư.",
    categories: ["General"],
  },
  {
    ...
    phonetic: "/trʌst/",
    partOfSpeech: "noun/verb",
    meaningEn: "Firm belief in the reliability.",
    meaningVi: "Tin tưởng.",
    exampleEn: "Trust me.",
  ...
  },
  {
    ...
    meaningVi: "Sự thật.",
    exampleEn: "Tell the truth.",
    exampleVi: "Nói sự thật.",
    categories: ["General"],
  },
  {
    id: "gen-1644",
    ...
    phonetic: "/traɪ/",
    partOfSpeech: "verb/noun",
    meaningEn: "Make an attempt or effort to do something.",
    meaningVi: "Thử.",
    exampleEn: "Try again.",
    exampleVi: "Thử lại.",
    categories: ["General"],
  },
  {
    ...
    phonetic: "/tuːb/",
    partOfSpeech: "noun",
    meaningEn: "A long hollow cylinder.",
    meaningVi: "Ống.",
    exampleEn: "Paste tube.",
    exampleVi: "Tuýp kem.",
    categories: ["General"],
  },
  {
    ...
    phonetic: "/ˈtuːz.deɪ/",
    partOfSpeech: "noun",
    meaningEn: "The day after Monday.",
    meaningVi: "Thứ Ba.",
    exampleEn: "On Tuesday.",
    exampleVi: "Vào thứ Ba.",
    categories: ["Daily"],
  },
  {
    id: "gen-1647",
    ...
    phonetic: "/ˈtuː.nə/",
    partOfSpeech: "noun",
    meaningEn: "A large and active predatory fish.",
    meaningVi: "Cá ngừ.",
    exampleEn: "Tuna salad.",
    exampleVi: "Salad cá ngừ.",
    categories: ["Food & Drink"],
  },
  {
    id: "gen-1648",
    ...
    phonetic: "/tuːn/",
    partOfSpeech: "noun/verb",
    meaningEn: "A melody or musical composition.",
    meaningVi: "Giai điệu.",
    exampleEn: "Catchy tune.",
    exampleVi: "Giai điệu bắt tai.",
    categories: ["Music"],
  },
  {
    id: "gen-1649",
    ...
    phonetic: "/ˈtʌn.əl/",
    partOfSpeech: "noun/verb",
    meaningEn: "An artificial underground passage.",
    meaningVi: "Đường hầm.",
  ...
  },
  {
    ...
    phonetic: "/ˈtɜːr.ki/",
    partOfSpeech: "noun",
    meaningEn: "A large主要是北美的一个国家.",
    meaningVi: "Thổ Nhĩ Kỳ.",
    exampleEn: "Travel to Turkey.",
    exampleVi: "Du lịch Thổ Nhĩ Kỳ.",
  ...
  },
  {
    ...
    phonetic: "/tɜːrn/",
    partOfSpeech: "verb/noun",
    meaningEn: "Move in a circular direction.",
    meaningVi: "Quay.",
    exampleEn: "Turn left.",
    exampleVi: "Rẽ trái.",
    categories: ["General"],
  ...
  },
  {
    ...
    phonetic: "/ˌtiːˈviː/",
    partOfSpeech: "noun",
    meaningEn: "Abbreviation of television.",
    meaningVi: "Ti vi.",
    exampleEn: "Watch TV.",
    exampleVi: "Xem ti vi.",
  ...
  },
  {
    ...
    phonetic: "/twelv/",
    partOfSpeech: "number",
    meaningEn: "The number 12.",
    meaningVi: "Mười hai.",
    exampleEn: "Twelve months.",
    exampleVi: "Mười hai tháng.",
    categories: ["General"],
  },
  {
    id: "gen-1654",
    ...
    phonetic: "/ˈtwen.ti/",
    partOfSpeech: "number",
    meaningEn: "The number 20.",
    meaningVi: "Hai mươi.",
    exampleEn: "Twenty years.",
    exampleVi: "Hai mươi năm.",
    categories: ["General"],
  },
  {
    id: "gen-1655",
    ...
    meaningEn: "Two times.",
    meaningVi: "Hai lần.",
    exampleEn: "Think twice.",
    exampleVi: "Hãy suy nghĩ kỹ.",
    categories: ["General"],
  },
  {
    id: "a1-106lgfd",
  ...
  },
  {
    ...
    phonetic: "/twɪst/",
    partOfSpeech: "verb/noun",
    meaningEn: "To turn something to form a curve or spiral.",
    meaningVi: "Xoắn, vặn.",
    exampleEn: "Twist the cap off the bottle.",
    exampleVi: "Vặn nắp chai ra.",
    categories: ["General"],
  },
  {
    id: "gen-1656",
    ...
    phonetic: "/taɪp/",
    partOfSpeech: "noun/verb",
    meaningEn: "A category of people or things.",
    meaningVi: "Loại.",
    exampleEn: "What type of music?",
    exampleVi: "Loại nhạc gì?",
    categories: ["General"],
  },
  {
    id: "b2-100",
