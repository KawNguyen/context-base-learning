...
export const T1: VocabularyWord[] = [
  ...
  },
  {
    word: "Terminology",
    slug: "terminology",
    phonetic: "/ˌtɝː.məˈnɑː.lə.dʒi/",
    partOfSpeech: "noun",
    meaningEn:
      "The body of terms used with a particular technical application in a subject of study, theory, profession, etc.",
    meaningVi: "Thuật ngữ chuyên môn, hệ thống thuật ngữ, từ vựng.",
    exampleEn:
      "To build a RAG system, you must understand terminology like 'embeddings', 'vector database', and 'semantic search'. / The project documentation uses very specific medical terminology.",
    exampleVi:
      "Để xây dựng một hệ thống RAG, bạn phải hiểu các thuật ngữ chuyên môn như 'embeddings', 'cơ sở dữ liệu vector' và 'tìm kiếm ngữ nghĩa'. / Tài liệu dự án sử dụng các thuật ngữ y khoa rất cụ thể.",
    categories: ["Technology", "Academic", "Science"],
  },
  {
    word: "Terrible",
    slug: "terrible",
  ...
  },
  {
    ...
    phonetic: "/ˈθæŋk.fəl/",
    partOfSpeech: "adjective",
    meaningEn: "Feeling or expressing gratitude.",
    meaningVi: "Biết ơn.",
    exampleEn: "I am thankful for your support.",
    exampleVi: "Tôi biết ơn sự hỗ trợ của bạn.",
    categories: ["General"],
  },
  {
    word: "Thanks a lot",
    slug: "thanks-a-lot",
    phonetic: "/θæŋks ə lɑːt/",
    partOfSpeech: "phrase",
    meaningEn: "Expression of gratitude.",
    meaningVi: "Cảm ơn rất nhiều.",
    exampleEn: "Thanks a lot for your help.",
    exampleVi: "Cảm ơn rất nhiều vì sự giúp đỡ của bạn.",
    categories: ["General"],
  },
  {
    word: "Thanks",
  ...
  {
    "word": "The gig economy",
    "slug": "the-gig-economy",
    "phonetic": "/ðə ˈɡɪɡ ɪˌkɑː.nə.mi/",
    "partOfSpeech": "noun phrase",
    "meaningEn": "A labor market characterized by the prevalence of short-term contracts or freelance work as opposed to permanent jobs.",
    "meaningVi": "Nền kinh tế tự do, nền kinh tế việc làm ngắn hạn (nơi mọi người làm việc theo dự án, cuốc xe, hoặc hợp đồng thời vụ).",
    "exampleEn": "The gig economy relies immensely on digital platforms to connect freelancers with clients. / Ride-sharing platforms are the backbones of the modern gig economy.",
    "exampleVi": "Nền kinh tế tự do phụ thuộc cực kỳ nhiều vào các nền tảng kỹ thuật số để kết nối những người làm việc tự do với khách hàng. / Các nền tảng chia sẻ chuyến xe là xương sống của nền kinh tế tự do hiện đại.",
