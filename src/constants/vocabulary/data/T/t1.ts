...
export const T1: VocabularyWord[] = [
  ...
  },
  {
    ...
    meaningVi:
      "Nền kinh tế tự do, nền kinh tế việc làm ngắn hạn (nơi mọi người làm việc theo dự án, cuốc xe, hoặc hợp đồng thời vụ).",
    exampleEn:
      "The gig economy relies immensely on digital platforms to connect freelancers with clients. / Ride-sharing platforms are the backbones of the modern gig economy.",
    exampleVi:
      "Nền kinh tế tự do phụ thuộc cực kỳ nhiều vào các nền tảng kỹ thuật số để kết nối những người làm việc tự do với khách hàng. / Các nền tảng chia sẻ chuyến xe là xương sống của nền kinh tế tự do hiện đại.",
