...
export const C19: VocabularyWord[] = [
  ...
  },
  {
    word: "cross-cultural",
    slug: "cross-cultural",
    phonetic: "/ˈkrɑːs ˈkʌltʃərəl/",
    partOfSpeech: "adjective",
    meaningEn: "Involving or relating to different cultures.",
    meaningVi: "Liên quan đến các nền văn hóa khác nhau.",
    exampleEn: "Cross-cultural communication.",
    exampleVi: "Giao tiếp đa văn hóa.",
    categories: ["Social", "General"],
  },
  {
    word: "Cross-culturally",
    slug: "cross-culturally",
    phonetic: "/ˈkrɑːs ˈkʌltʃərəli/",
    partOfSpeech: "adverb",
    meaningEn: "In a way that involves or relates to different cultures.",
    meaningVi: "Theo cách liên quan đến các nền văn hóa khác nhau.",
    exampleEn: "Cross-culturally relevant.",
    exampleVi: "Có tính liên quan đến nhiều nền văn hóa.",
    categories: ["Social", "General"],
  },
  {
