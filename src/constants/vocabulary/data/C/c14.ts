...
export const C14: VocabularyWord[] = [
  ...
  },
  {
    word: "Coordinated",
    slug: "coordinated",
    phonetic: "/koʊˈɔːr.də.neɪ.tɪd/",
    partOfSpeech: "adjective",
    meaningEn: "Organized in a harmonious way.",
    meaningVi: "Được phối hợp một cách hài hòa.",
    exampleEn: "Coordinated team.",
    exampleVi: "Đội ngũ được phối hợp tốt.",
