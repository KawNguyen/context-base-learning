...
export const O1: VocabularyWord[] = [
  ...
  },
  {
    ...
    phonetic: "/ˈɔː.fɚ/",
    partOfSpeech: "verb",
    meaningEn: "Present for acceptance/Giving or providing something.",
    meaningVi: "Đề nghị/Mang lại, đem lại.",
  ...
  },
  {
    ...
    meaningEn:
      "A thing offered, especially as a gift or contribution/Giving or providing something.",
  ...
  },
  {
    ...
    partOfSpeech: "adj",
    meaningEn: "Continuing; still in progress.",
    meaningVi: "Đang diễn ra.",
    exampleEn:
      "The ongoing project is expected to be completed by the end of the year.",
    exampleVi: "Dự án đang diễn ra dự kiến sẽ hoàn thành vào cuối năm.",
    categories: ["General"],
  },
  {
    word: "Onion",
    ...
    phonetic: "/ˈʌn.jən/",
    partOfSpeech: "noun",
    meaningEn: "A vegetable with a strong smell and flavor.",
    meaningVi: "Hành tây.",
    exampleEn: "Chopped onions.",
    exampleVi: "Hành tây băm nhỏ.",
    categories: ["Food & Drink"],
  },
  {
    word: "Online",
  ...
  },
  {
    word: "Optionality",
    slug: "optionality",
    phonetic: "/ˌɑːp.ʃəˈnæl.ə.ti/",
    partOfSpeech: "noun",
    meaningEn: "The quality of being optional.",
    meaningVi: "Tính tùy chọn.",
    exampleEn: "The optionality of the contract allows for flexibility.",
    exampleVi: "Tính tùy chọn của hợp đồng cho phép sự linh hoạt.",
