...
export const G1: VocabularyWord[] = [
  ...
  },
  {
    word: "Gatekeeper",
    slug: "gatekeeper",
    phonetic: "/ˈɡeɪt.kiːp.ər/",
    partOfSpeech: "noun",
    meaningEn: "A person who controls access to a place or building.",
    meaningVi: "Người canh cổng, người giữ cửa, người bảo vệ, người kiểm soát.",
    exampleEn: "The gatekeeper let us in.",
    exampleVi: "Người canh cổng đã cho chúng tôi vào.",
    categories: ["Jobs"],
  },
  {
    word: "Gateway",
  ...
  },
  {
    ...
    phonetic: "/ɡet/",
    partOfSpeech: "verb",
    meaningEn: "Obtain, receive, or come to have something.",
    meaningVi: "Nhận được; có được.",
    exampleEn: "I need to get a new phone.",
    exampleVi: "Tôi cần mua một chiếc điện thoại mới.",
    categories: ["General"],
  },
  {
    word: "Get along",
  ...
  },
  {
    ...
    phonetic: "/ɡet ɪn/",
    partOfSpeech: "phrasal verb",
    meaningEn: "Enter a vehicle.",
    meaningVi: "Lên xe.",
    exampleEn: "Get in the car.",
    exampleVi: "Lên xe đi.",
    categories: ["Phrasal Verb"],
  },
  {
    ...
    phonetic: "/ɡet lɔːst/",
    partOfSpeech: "phrasal verb",
    meaningEn: "Go away; disappear; become absorbed in.",
    meaningVi: "Đi mất; biến mất; bị cuốn vào; đắm chìm trong.",
    exampleEn: "Get lost!",
    exampleVi: "Đi mất!",
    categories: ["Phrasal Verb"],
  },
