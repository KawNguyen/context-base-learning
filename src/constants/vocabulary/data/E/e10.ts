...
export const E10: VocabularyWord[] = [
  ...
  },
  {
    ...
    word: "Expressly",
    slug: "expressly",
    phonetic: "/ɪkˈspres.li/",
    partOfSpeech: "adverb",
    meaningEn: "Clearly and openly.",
    meaningVi: "Một cách rõ ràng/Cụ thể.",
    exampleEn: "Expressly forbidden.",
    exampleVi: "Bị cấm một cách rõ ràng.",
    categories: ["General"],
  },
  {
    id: "gen-7563",
    ...
    partOfSpeech: "adjective",
    meaningEn: "Extremely beautiful and, typically, delicate.",
  ...
  },
  {
    ...
    word: "Exquisitely",
    slug: "exquisitely",
    phonetic: "/ɪkˈskwɪz.ɪt.li/",
    partOfSpeech: "adverb",
    meaningEn: "In an extremely beautiful and delicate manner.",
  ...
  },
  {
    ...
    phonetic: "/ɪkˈstend/",
    partOfSpeech: "verb",
    meaningEn: "Cause to cover a wider area; make larger.",
    meaningVi: "Mở rộng.",
    exampleEn: "Extend the deadline.",
    exampleVi: "Gia hạn thời hạn.",
    categories: ["General"],
  },
  {
    id: "gen-7566",
    ...
    partOfSpeech: "adjective",
    meaningEn: "Made larger; enlarged.",
    meaningVi: "Mở rộng/Kéo dài.",
    exampleEn: "Extended family.",
    exampleVi: "Đại gia đình.",
    categories: ["General"],
  },
  {
    id: "gen-7567",
    ...
    partOfSpeech: "noun",
    meaningEn: "A part that is added to something to enlarge or prolong it.",
  ...
  },
  {
    ...
    partOfSpeech: "adjective",
    meaningEn: "Covering or affecting a large area.",
    meaningVi: "Rộng rãi/Bao quát.",
    exampleEn: "Extensive damage.",
    exampleVi: "Thiệt hại trên diện rộng.",
    categories: ["General"],
  },
  {
    id: "gen-7569",
    ...
    partOfSpeech: "adverb",
    meaningEn: "To a large extent; widely.",
  ...
  },
  {
    ...
    phonetic: "/ɪkˈstent/",
    partOfSpeech: "noun",
    meaningEn: "The area covered by something.",
    meaningVi: "Quy mô/Phạm vi/Mức độ.",
    exampleEn: "To some extent.",
  ...
  },
  {
    ...
    word: "Exterior",
    slug: "exterior",
    phonetic: "/ɪkˈstɪr.i.ɚ/",
    partOfSpeech: "adjective/noun",
    meaningEn: "Forming, situated on, or relating to the outside of something.",
  ...
  },
  {
    ...
    word: "Exterminate",
    slug: "exterminate",
    phonetic: "/ɪkˈstɝː.mə.neɪt/",
    partOfSpeech: "verb",
    meaningEn: "Destroy completely.",
    meaningVi: "Tiêu diệt/Hủy diệt.",
    exampleEn: "Exterminate pests.",
    exampleVi: "Tiêu diệt sâu bệnh.",
    categories: ["General"],
  },
  {
    id: "gen-7573",
  ...
  },
  {
    ...
    partOfSpeech: "verb",
    meaningEn: "Cause (a fire or light) to cease to burn or shine.",
    meaningVi: "Dập tắt.",
    exampleEn: "Extinguish a fire.",
    exampleVi: "Dập cháy.",
    categories: ["General"],
  },
  {
    ...
    phonetic: "/ɪkˈstoʊl/",
    partOfSpeech: "verb",
    meaningEn: "Praise enthusiastically.",
    meaningVi: "Ca ngợi/Tán dương.",
    exampleEn: "Extol the virtues.",
    exampleVi: "Ca ngợi những đức tính.",
    categories: ["General"],
  },
  {
    id: "gen-7579",
    ...
    phonetic: "/ɪkˈstɔːrt/",
    partOfSpeech: "verb",
    meaningEn: "Obtain (something) by force, threats, or other unfair means.",
  ...
  },
  {
    ...
    phonetic: "/ˈek.strə/",
    partOfSpeech: "adjective/noun",
    meaningEn: "Added to an existing amount.",
    meaningVi: "Thêm.",
    exampleEn: "Extra time.",
    exampleVi: "Thời gian thêm.",
    categories: ["General"],
  },
  {
    id: "gen-7582",
    ...
    meaningEn: "Remove or take out, especially by effort or force.",
  ...
  },
  {
    ...
    word: "Extractor",
    slug: "extractor",
    phonetic: "/ɪkˈstræk.tɚ/",
    partOfSpeech: "noun",
    meaningEn: "A machine or device used to extract something.",
  ...
  },
  {
    ...
    word: "Extraneous",
    slug: "extraneous",
    phonetic: "/ɪkˈstreɪ.ni.əs/",
    partOfSpeech: "adjective",
    meaningEn: "Irrelevant or unrelated to the subject being dealt with.",
    meaningVi: "Không liên quan/Xa lạ.",
    exampleEn: "Extraneous information.",
    exampleVi: "Thông tin không liên quan.",
    categories: ["General"],
  },
  {
    id: "gen-7589",
    word: "Extraordinarily",
    slug: "extraordinarily",
    phonetic: "/ɪkˌstrɔːr.dəˈner.əl.i/",
    partOfSpeech: "adverb",
    meaningEn: "In a very unusual or remarkable way.",
    meaningVi: "Một cách phi thường.",
    exampleEn: "Extraordinarily beautiful.",
    exampleVi: "Đẹp một cách phi thường.",
    categories: ["General"],
  },
  {
    id: "gen-7590",
    word: "Extraordinary",
    slug: "extraordinary",
    phonetic: "/ɪkˈstrɔːr.də.ner.i/",
    partOfSpeech: "adjective",
    meaningEn: "Very unusual or remarkable.",
    meaningVi: "Phi thường/Đặc biệt.",
    exampleEn: "Extraordinary talent.",
    exampleVi: "Tài năng phi thường.",
    categories: ["General"],
  },
  {
    id: "gen-7591",
  ...
  },
  {
    ...
    word: "Extrasensory",
    slug: "extrasensory",
    phonetic: "/ˌek.strəˈsen.sər.i/",
    partOfSpeech: "adjective",
    meaningEn: "Outside one's normal sense perception.",
    meaningVi: "Ngoại cảm.",
  ...
  },
  {
    ...
    partOfSpeech: "adjective/noun",
    meaningEn: "Of or from outside the earth or its atmosphere.",
  ...
  },
  {
    ...
    word: "Extravagance",
    slug: "extravagance",
    phonetic: "/ɪkˈstræv.ə.ɡəns/",
    partOfSpeech: "noun",
    meaningEn: "Lack of restraint in spending money or use of resources.",
  ...
  },
  {
    ...
    partOfSpeech: "adjective",
    meaningEn: "Lacking restraint in spending money or using resources.",
  ...
  },
  {
    ...
    phonetic: "/ɪkˈstriːm/",
    partOfSpeech: "adjective/noun",
    meaningEn: "Reaching a high or the highest degree.",
    meaningVi: "Cực đoan.",
    exampleEn: "Extreme weather.",
    exampleVi: "Thời tiết khắc nghiệt.",
    categories: ["General"],
  },
  {
    id: "gen-7598",
    ...
    partOfSpeech: "adverb",
    meaningEn: "To a very great degree; very.",
    meaningVi: "Vô cùng/Cực kỳ.",
    exampleEn: "Extremely difficult.",
    exampleVi: "Vô cùng khó khăn.",
    categories: ["General"],
  },
  {
    id: "gen-7599",
  ...
  },
  {
    ...
    word: "Extremity",
    slug: "extremity",
    phonetic: "/ɪkˈstrem.ə.t̬i/",
    partOfSpeech: "noun",
    meaningEn: "The furthest point or limit of something.",
  ...
  },
  {
    ...
    word: "Extricate",
    slug: "extricate",
    phonetic: "/ˈek.strə.keɪt/",
    partOfSpeech: "verb",
    meaningEn: "Free (someone or something) from a constraint or difficulty.",
    meaningVi: "Giải thoát/Gỡ bỏ.",
    exampleEn: "Extricate from a trap.",
    exampleVi: "Giải thoát khỏi bẫy.",
    categories: ["General"],
  },
  {
    id: "gen-7602",
  ...
  },
  {
    ...
    word: "Extrovert",
    slug: "extrovert",
    phonetic: "/ˈek.strə.vɝːt/",
    partOfSpeech: "noun",
    meaningEn: "An outgoing, overtly expressive person.",
  ...
  },
  {
    ...
    phonetic: "/ɪɡˈzuːd/",
    partOfSpeech: "verb",
    meaningEn: "Discharge (moisture or a smell) slowly and steadily.",
    meaningVi: "Rỉ ra/Toát ra.",
    exampleEn: "Exude confidence.",
    exampleVi: "Toát ra sự tự tin.",
    categories: ["General"],
  },
  {
    id: "gen-7607",
  ...
  },
  {
    ...
    word: "Exultant",
    slug: "exultant",
    phonetic: "/ɪɡˈzʌl.tənt/",
    partOfSpeech: "adjective",
    meaningEn: "Triumphantly happy.",
    meaningVi: "Hân hoan/Phấn khởi.",
    exampleEn: "Exultant crowd.",
    exampleVi: "Đám đông hân hoan.",
    categories: ["General"],
  },
  {
    id: "gen-7609",
    word: "Exultation",
    slug: "exultation",
    phonetic: "/ˌeɡ.zʌlˈteɪ.ʃən/",
    partOfSpeech: "noun",
    meaningEn: "A feeling of triumphant elation or jubilation.",
    meaningVi: "Sự hân hoan/Sự hoan hỉ.",
    exampleEn: "Cries of exultation.",
    exampleVi: "Những tiếng hò reo hân hoan.",
    categories: ["General"],
  },
  {
    id: "a1-116",
  ...
  },
  {
    ...
    phonetic: "/ˈaɪ.bɑːl/",
    partOfSpeech: "noun",
    meaningEn: "The round part of the eye of a vertebrate, within the eyelids.",
    meaningVi: "Nhãn cầu.",
  ...
  },
  {
    ...
    phonetic: "/ˈaɪ.saɪt/",
    partOfSpeech: "noun",
    meaningEn: "A person's ability to see.",
    meaningVi: "Thị lực.",
    exampleEn: "Poor eyesight.",
    exampleVi: "Thị lực kém.",
    categories: ["Medical"],
  },
  {
    id: "gen-7617",
