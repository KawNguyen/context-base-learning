...
export const B1: VocabularyWord[] = [
  ...
  },
  {
    ...
    phonetic: "/ˈbæŋ.kɪŋ/",
    partOfSpeech: "noun",
    meaningEn: "The business conducted or services offered by a bank.",
    meaningVi: "Ngân hàng (hoạt động).",
    exampleEn: "Online banking is very convenient.",
    exampleVi: "Ngân hàng trực tuyến rất tiện lợi.",
    categories: ["Business", "Finance"],
  },
  {
    id: "gen-2325",
