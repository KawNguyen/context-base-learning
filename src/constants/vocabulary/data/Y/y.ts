...
export const Y1: VocabularyWord[] = [
  ...
  },
  {
    ...
    meaningEn: "Of the color of a lemon or an egg yolk.",
    meaningVi: "Vàng.",
    exampleEn: "Yellow flowers.",
    exampleVi: "Hoa vàng.",
    categories: ["General"],
  },
  {
  ...
  },
  {
    ...
    meaningEn: "On the day before today.",
    meaningVi: "Hôm qua.",
    exampleEn: "Yesterday morning.",
    exampleVi: "Sáng hôm qua.",
    categories: ["Daily"],
  },
  {
    id: "gen-1876",
  ...
  },
  {
    ...
    meaningEn: "Produce or provide.",
    meaningVi: "Sản lượng/Nhường.",
    exampleEn: "Crop yield.",
    exampleVi: "Năng suất cây trồng.",
