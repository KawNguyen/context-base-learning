...
export const F5: VocabularyWord[] = [
  ...
  },
  {
    ...
    partOfSpeech: "noun",
    meaningEn: "The feeling of being upset or annoyed.",
    meaningVi: "Sự thất vọng/Bực bội.",
    exampleEn: "He expressed his frustration with the situation.",
  ...
  },
  {
    word: "Functional",
    slug: "functional",
    phonetic: "/ˈfʌŋk.ʃən.əl/",
    partOfSpeech: "adjective",
    meaningEn: "Designed to be practical and useful.",
    meaningVi: "Có chức năng/Thực dụng.",
    exampleEn: "A functional design.",
    exampleVi: "Một thiết kế thực dụng.",
  ...
  },
  {
    ...
    partOfSpeech: "noun/verb",
    meaningEn:
      "A sum of money saved or made available for a particular purpose; to provide money for a particular purpose.",
    meaningVi: "Quỹ/Tài trợ.",
    exampleEn: "The government set up a fund for education.",
    exampleVi: "Chính phủ đã thành lập một quỹ cho giáo dục.",
  ...
  },
  {
    ...
    meaningVi: "Cơ bản/Quan trọng.",
    exampleEn: "Fundamental principles.",
    exampleVi: "Những nguyên tắc cơ bản.",
  ...
  },
  {
    ...
    partOfSpeech: "adverb",
    meaningEn: "In a fundamental way; essentially.",
    meaningVi: "Về cơ bản.",
    exampleEn: "The two theories are fundamentally different.",
    exampleVi: "Hai lý thuyết này về cơ bản là khác nhau.",
    categories: ["General"],
  },
  {
    word: "Further",
