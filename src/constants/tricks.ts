...
export const tricks: Trick[] = [
    ...
    },
    {
        ...
        explanationVi: "Trạng từ có vị trí linh hoạt hơn tính từ, thường bổ nghĩa cho động từ, tính từ hoặc trạng từ khác. Đây là phần cực kỳ quan trọng trong TOEIC Part 5.",
        rules: [
            { title: "Mid-position (Trợ động từ)", contentVi: "Đứng giữa trợ động từ và động từ chính: Be + Adv + V-ing/V3; Have + Adv + V3; Modal + Adv + V." },
            { title: "S + Adv + V", contentVi: "Đứng trước động từ thường để bổ nghĩa cho hành động." },
            { title: "V + (O) + Adv", contentVi: "Đứng sau nội động từ hoặc sau tân ngữ của ngoại động từ (Lưu ý: Không đứng giữa V và O)." },
            { title: "Be + Adv + Adj", contentVi: "Bổ nghĩa cho tính từ khi tính từ đó đứng sau động từ to be." },
            { title: "Adv + Adj/Adv", contentVi: "Bổ nghĩa cho tính từ hoặc trạng từ khác." },
            { title: "Sentence Adverbs", contentVi: "Đứng ở đầu câu (trước dấu phẩy) để bổ nghĩa cho toàn bộ nội dung phía sau." },
        ],
        examples: [
            { en: "The project has successfully been completed.", vi: "Dự án đã được hoàn thành một cách thành công. (Have + Adv + V3)" },
            { en: "She carefully reviewed the contract.", vi: "Cô ấy đã xem xét hợp đồng một cách cênt thận. (S + Adv + V)" },
            { en: "The manager speaks English extremely well.", vi: "Người quản lý nói tiếng Anh cực kỳ tốt. (Adv + Adv)" },
            { en: "It is a highly competitive market.", vi: "Đó là một thị trường cạnh tranh cao. (Adv + Adj)" },
            { en: "Unfortunately, the meeting was postponed.", vi: "Thật không may, cuộc họp đã bị trì hoãn. (Đứng đầu câu)" },
        ],
    },
    {
        ...
        explanationVi: "Một số trạng từ có hình thức gần giống nhau nhưng ý nghĩa hoàn toàn khác biệt, thường xuất hiện trong các câu hỏi từ vựng.",
        signs: [
            { sign: "Hard vs Hardly", explanationVi: "Hard: chăm chỉ/vất vả; Hardly: hầu như không." },
            { sign: "Late vs Lately", explanationVi: "Late: muộn; Lately: gần đây (= Recently)." },
            { sign: "Near vs Nearly", explanationVi: "Near: gần (khoảng cách); Nearly: gần như/xấp xỉ (= Almost)." },
            { sign: "High vs Highly", explanationVi: "High: cao (vị trí); Highly: rất/hết sức (mức độ)." },
            { sign: "Short vs Shortly", explanationVi: "Short: ngắn/thấp; Shortly: ngay sau đó/sớm (= Soon)." },
        ],
        examples: [
            { en: "He works hard to support his family.", vi: "Anh ấy làm việc chăm chỉ để nuôi gia đình." },
            { en: "I can hardly hear what you are saying.", vi: "Tôi hầu như không nghe thấy bạn đang nói gì." },
            { en: "The flight will depart shortly.", vi: "Chuyến bay sẽ sớm khởi hành." },
